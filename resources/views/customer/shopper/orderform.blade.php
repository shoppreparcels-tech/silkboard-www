        ...
        <div class="col-sm-12">
          ...
          <div class="prnslmain">
            <div class="orderForm">
              ...
              <form class="form-horizontal" id="order_form" method="post" action="{{route('personal.shopper.submit')}}">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <input type="text" class="form-control" name="item_num" value="{{ old('item_num') }}">
                  </div>
                </div>
                <div class="form-group">
