          ...
          <div class="col-sm-12 ">
            <div class="longblock">
              <h4 class="title">Ship Request Response</h4>
                ...
                <p class="confirm">An email confirmation of your request has been sent to your mail address. You can track your ship request in <a href="{{route('shipping.queue')}}">Queue</a></p>
                ...
                <div class="col-sm-6">
                  <div class="splitbox">
                    ...
                    <p>Estimated Cost: <i class="fa fa-rupee"></i> {{$shipment->finalamount}}</p>
                  </div>
                </div>
