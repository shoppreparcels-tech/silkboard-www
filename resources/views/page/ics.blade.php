                    ...
                    <div class="tab-content tabs">
                        ...
                        <div role="tabpanel" class="tab-pane fade" id="Domestic">
                            <div class="col-lg-12 col-md-12 ">
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12"><input class="text-box-margin"
                                                                                          type="text" name=""
                                                                                          placeholder="Weight(kg)">
            ...
            <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                <div class="col-md-4 col-lg-4 col-sm-6 col-sm-6 box">
                    <div class="box-steps" id="steps">
                        <center>
                            <p class="header6 p-color-cement" style="line-height: 1;"><span
                                    style="font-size: 22px;font-weight: 900;">1</span><br> step</p>
                        </center>
                    </div>
                    <div>
                        <center>
                            <img class="img-responsive img-process" src="{{asset('img/svg_image/pic_up.svg')}}">
                ...
                <div class="col-md-4 col-lg-4 col-sm-6 col-sm-6 box">
                    <div class="box-steps" id="steps">
                        <center>
                            <p class="header6 p-color-cement" style="line-height: 1;"><span
                                    style="font-size: 22px;font-weight: 900;">2</span><br> step</p>
                        </center>
                    </div>
                    <div>
                        <center>
                ...
                <div class="col-md-4 col-lg-4 col-sm-6 col-sm-6 box">
                    <div class="box-steps" id="steps">
                        <center>
                            <p class="header6 p-color-cement" style="line-height: 1;"><span
                                    style="font-size: 22px;font-weight: 900;">3</span><br> step</p>
                        </center>
                    </div>
                    <div>
                        <center>
