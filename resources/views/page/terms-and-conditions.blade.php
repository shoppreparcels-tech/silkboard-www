    ...
    <section class="page_head">
        <div class="pagebanner">
          ...
          <div class="banner-cap">
            <h2>Our <span class="text-orange">Privacy Policy</span></h2>
          </div>
        </div>
    </section>
    ...
    <section class="service-sec">
      <div class="container">      
        <div class="col-md-12">
            ...
            <h4>You agree to adhere to the following guidelines when using this Website:</h4>
            <p class="policy-paragraph">
            	<ul class="policy-paragraph">

                <li>You may not defame, abuse, harass, stalk, threaten or otherwise violate the legal rights (such as rights of privacy and publicity) of others.</li>
                ...
                <li>You may not falsify the origin or source of information or material published, posted, advertised, distributed, disseminated, or uploaded.
				You may not conduct or forward surveys, contests, chain letters, or commercial solicitations.</li>
                <li>You may not download any material or information published, posted, distributed, disseminated, or uploaded by another user that you know, or reasonably should know, cannot be legally distributed in such manner.</li>
                <li>You may not provide personal information, as that term is defined in the Privacy Policy, of another person without his or her express permission.
				You may not provide personal information, as that term is defined in the Privacy Policy, of individuals under the age of 13.</li>
                <li>You may not access or attempt to access Shoppre.com's information technology systems, environments, networks, files, data or accounts to which express authorization has not been obtained, or log into a server that you are not authorized to access.</li>
                <li>You may not attempt to circumvent or subvert system or network security mechanisms, or probe the security of any system, network, or account associated or used in conjunction with the Website.</li>
            ...
            <p class="policy-paragraph">
             ...
             <p class="policy-paragraph"> 
                ...
                <li>Firearms, weaponry and their parts:
                ...
                <li>Perishable foods (refrigerated, frozen, fresh/raw fruits and vegetables, etc.) Note that any food (including dietary supplements) received through Shoppre.com may not be returned to or resold in India.</li>
                <li>Animals and products made with animal skin (furs).</li>
                <li>Alcohol (Shoppre.com may be able to assist you with shipping table wine through unaffiliated freight forwarders and carriers in limited quantities to some countries, but not to Muslim countries such as Saudi Arabia).</li>
                <li>Cash, currency, money orders, cashiers' checks, bank drafts, bearer bonds and collectible stamps and coins, Jewelry and precious stones.</li>
             ...
             <h3>C. Prohibited and Restricted End Users and  Destinations</h3>
             ...
             <p class="policy-paragraph">
					<ul class="policy-paragraph">
                       <li>Shoppre.com uses commercially reasonable efforts to prevent fraudulent use of the Website. NOTWITHSTANDING THE
						FOREGOING, Shoppre.com WILL NOT BE LIABLE FOR ANY LOSS OR DAMAGE CAUSED BY FRAUDULENT USE OF THE WEBSITE BY YOU OR BY THIRD PARTIES. If you think there has been fraudulent activity with respect to your account, you must contact Shoppre.com immediately, and Shoppre.com will cancel such account.</li>
	            ...
	            <h3>IV. APPOINTMENT OF Shoppre.com AS MEMBER'S AGENT</h3>
	            <p class="policy-paragraph">
					...
					<ul>
						<li>preparation of shipping documents; preparation of any Certificates of Origin;</li>
	            ...
	            <p class="policy-paragraph"> 
					...
					<ul>
						...
						<li>any breach or nonperformance of any covenant or agreement made by Company in this Agreement or any other document or instrument made by Member in connection with this Agreement;</li>
						<li>Shoppre.com's preparation, determination or execution of the documents or any other document necessary for transportation, including but not limited to preparing address information, routing, classification, licensing requirements, and listing the value of goods or the value for carriage, except for claims arising solely from the gross negligence or willful misconduct of Shoppre.com;</li>
						<li>the Member providing to Shoppre.com any incomplete or false information; and</li>
						...
						<li>The Member acknowledges that the foregoing provisions are a material inducement for Shoppre.com to enter into this Agreement and the transactions contemplated hereby, and shall survive termination of this Agreement.</li>

					</ul>
	            </p>
	            <h3>VI. SEVERABILITY</h3>
	            <p class="policy-paragraph">Any use in contravention of this provision or any provision of this Agreement is at your own risk and, if any part of this Agreement is invalid or unenforceable under applicable law, the invalid or unenforceable provision will be deemed superseded by a valid, enforceable provision that most closely matches the intent of the original provision and the remainder of the agreement shall govern such use.</p>
	            <h3>VII. NO LEGAL RELATIONSHIP</h3>
	            <p class="policy-paragraph">You agree that no joint venture, partnership, employment, or agency relationship (other than as expressly set forth in these Terms and Conditions) exists between you and Shoppre.com as a result of this Agreement or your use of this Website.</p>
	            <h3>VIII. ENTIRE AGREEMENT</h3>
	            <p class="policy-paragraph">This Agreement constitutes the entire agreement between you and Shoppre.com with respect to this Website. This Agreement supersedes all prior or contemporaneous communications and proposals, whether electronic, oral, or written, between you and Shoppre.com with respect to this Website. Any alleged waiver of any breach of this Agreement shall not be deemed to be a waiver of any future breach.</p>
	            <h3>IX. CONFLICT OF LAWS</h3>
	            <p class="policy-paragraph">
