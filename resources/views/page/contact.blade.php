            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="no-padding address-details">
                        <h4>Locations</h4>
                        <span class="under-line"><img src="{{env('CDN_IMAGE_URL')}}/shoppre.com/cdn/img/images/line.png"></span>
                        ...
                        <ul class="list-inline list-unstyled">
                            <li>
                                <a href="https://www.youtube.com/channel/UCCBP1ybWY9spoleKqMgAQaw">
                                    <img class="img-connect" src="{{env('CDN_IMAGE_URL')}}/shoppre.com/cdn/img/svg/shoppre-youtube-video.svg">
                                </a>
                            </li>
                            <li>
                                <a href="https://www.facebook.com/goshoppre/">
                                    <img class="img-connect" src="{{env('CDN_IMAGE_URL')}}/shoppre.com/cdn/img/svg/go-shoppre-faceboook.svg">
                                </a>
                            </li>
                            <li>
