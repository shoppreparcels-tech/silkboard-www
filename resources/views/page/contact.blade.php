    ...
    <section class="contact_ico">
        <div class="container">
            ...
            <div class="blox">
                ...
                <h4>Live Chat</h4>
                <span><a href="https://tawk.to/chat/59d72784c28eca75e4624678/default/?$_tawk_popout=true"
...
@section('js_script')
    ...
    <script async defer
            src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDQzl11fjwwyiw_KRIV61HN7U-5HPPwmLQ&callback=initialize">
    </script>
@endsection
