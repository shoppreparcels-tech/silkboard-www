...
@section('content')
        ...
        <div class="container">
            <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                <center>
                    ...
                    <p class="header2 p-color-cement" style="margin-bottom: 115px;">We recive your order at our branch and
                        can provide Storage,<br> Repackaging and Consolidation Service to send at your abroad address
                    </p>
    ...
    <section>
        <div class="container">
            <div style="margin: 77px 0 13px  0 ;">
                <center>
                    ...
                    <p class="header2 p-color-cement">We recive your order at our branch and can provide Storage,<br>
        ...
        <div class="container" style="background-color: #fafafb;">
            <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12 box box-ifs-container">
                <div class="row">
                    <div class="col-md-2  col-lg-2 col-xs-4 col-sm-4">
                        <div class="box-ifs" id="step1">
                            <center>
                                <p class="header4 p-color-cement">1 <br> STEP </p>
                            </center>
                        </div>
                    </div>
                    <div class="col-md-5 col-lg-6 col-xs-6 col-sm-12">
                        <center>
                            <h3 class="header3 p-color-cement-dark" style="margin-top: 36px;">Get a Free Virtual Address</h3>
                        </center>
                ...
                <div class="row" style="margin-top: 83px;">
                    <center>
                        <img class="img-responsive img-ifs-v_addres " src="img/images/70-layers.png">
                    </center>

                    <!-- <div class="col-md-4 col-lg-4 col-sm-4 col-xs-4">
                       <center>
                           <div class="div-ifs-register">
                                <h2 class="header4 p-color-cement-dark" style="margin-top: 72px;">Register</h2>
                           </div>
                       </center>
                    </div>
                     <div class="col-md-2 col-lg-2 col-sm-2 col-xs-2">
                         <h3 class="header4 p-color-red" style="margin-top: 42px;">AND GET</h3>
                         <div style="width: 108px;height: 1px;border: 2px dashed #e85151; "></div>
                     </div>
                    <div class="col-md-6 col-lg-6 col-sm-6 col-xs-6">
                       <img class="img-responsive" src="img/images/66-layers.png">
                    </div>-->
                </div>
            </div>
            ...
            <div class="col-md-3 col-lg-3 col-sm-6 col-xs-6 box">
                <center>
                    <div class="box-ifs">
                        <p class="header4 p-color-cement">2 <br> STEP</p>
                    </div>

                    <h3 class="header3 p-color-cement-dark p-ifs-margin-h">Purchase</h3>
                    <p class="header4 p-color-cement p-ifs-margin-d">
                        Purchase any <br> product from your <br> favourite indian <br> online store and <br>use your
                        locker <br>address for item <br> delivery.
                    </p>
                </center>
            </div>
            <div class="col-md-3 col-lg-3 col-sm-6 col-xs-6 box">
                <center>
                    <div class="box-ifs">
                        <p class="header4 p-color-cement">3 <br> STEP</p>
                    </div>
                    <h3 class="header3 p-color-cement-dark p-ifs-margin-h">Receive</h3>
                    <p class="header4 p-color-cement p-ifs-margin-d">
                        We will ship your <br> product to your <br> abroad address <br> with upto 80% less <br> delivery
                        cost. <br> <br> Enjoy!
                    </p>
                </center>
            </div>
