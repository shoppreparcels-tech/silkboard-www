            ...
            <div class="col-md-6 col-sm-12 col-xs-12 " style="padding-top: 50px">
                ...
                <div class=" col-md-12 col-xs-12 div-ics-prodcts">
                    <div class="col-md-6 col-xs-6 no-padding">
                        <ul>
                            <li><img src="{{env('CDN_IMAGE_URL')}}/shoppre.com/cdn/img/svg/Ellipse.svg" > Pills</li>
                            <li><img src="{{env('CDN_IMAGE_URL')}}/shoppre.com/cdn/img/svg/Ellipse.svg" > Herbs</li>
                            <li><img src="{{env('CDN_IMAGE_URL')}}/shoppre.com/cdn/img/svg/Ellipse.svg" > Liquid/Syrups</li>
                            <li><img src="{{env('CDN_IMAGE_URL')}}/shoppre.com/cdn/img/svg/Ellipse.svg" > Ointments</li>
                            <li><img src="{{env('CDN_IMAGE_URL')}}/shoppre.com/cdn/img/svg/Ellipse.svg" > Inhalers</li>
                            <li><img src="{{env('CDN_IMAGE_URL')}}/shoppre.com/cdn/img/svg/Ellipse.svg" > Homeopathy</li>
                        </ul>
                    </div>
                    <div class="col-md-6 col-xs-6 no-padding">
                        <ul style="text-decoration: none; list-style: none">
                            <li><img src="{{env('CDN_IMAGE_URL')}}/shoppre.com/cdn/img/svg/Ellipse.svg" >Capsules</li>
                            <li><img src="{{env('CDN_IMAGE_URL')}}/shoppre.com/cdn/img/svg/Ellipse.svg" >Injections</li>
                            <li><img src="{{env('CDN_IMAGE_URL')}}/shoppre.com/cdn/img/svg/Ellipse.svg" >Tablets</li>
                            <li><img src="{{env('CDN_IMAGE_URL')}}/shoppre.com/cdn/img/svg/Ellipse.svg" >Eye/Ear Drops</li>
                            <li><img src="{{env('CDN_IMAGE_URL')}}/shoppre.com/cdn/img/svg/Ellipse.svg" >Lozenges</li>
            ...
            <div class="col-md-12 col-xs-12 no-pad">
                ...
                <div class=" col-md-12 col-xs-12 div-ics-prodcts">
                    <div class="col-md-6 col-xs-12 no-padding">
                        <ul>
                            <li><img src="{{env('CDN_IMAGE_URL')}}/shoppre.com/cdn/img/svg/Ellipse.svg" > Door to Door Pickup Services</li>
                            <li><img src="{{env('CDN_IMAGE_URL')}}/shoppre.com/cdn/img/svg/Ellipse.svg" > Customs Clearance And Paperwork</li>
                            <li><img src="{{env('CDN_IMAGE_URL')}}/shoppre.com/cdn/img/svg/Ellipse.svg" > Hassle Free Shipment Process</li>
                            <li><img src="{{env('CDN_IMAGE_URL')}}/shoppre.com/cdn/img/svg/Ellipse.svg" > Low Cost for higher Kgs</li>
                            <li><img src="{{env('CDN_IMAGE_URL')}}/shoppre.com/cdn/img/svg/Ellipse.svg" > Package Return Services</li>
                            <li><img src="{{env('CDN_IMAGE_URL')}}/shoppre.com/cdn/img/svg/Ellipse.svg" > Multiple Payment Options Available</li>
                        </ul>
                    </div>
                    <div class="col-md-6 col-xs-12 no-padding">
                        <ul>
                            <li><img src="{{env('CDN_IMAGE_URL')}}/shoppre.com/cdn/img/svg/Ellipse.svg" >Consolidation & Repackaging</li>
                            <li><img src="{{env('CDN_IMAGE_URL')}}/shoppre.com/cdn/img/svg/Ellipse.svg" >FREE Virtual Indian Address</li>
                            <li><img src="{{env('CDN_IMAGE_URL')}}/shoppre.com/cdn/img/svg/Ellipse.svg" >20-day FREE, safe storage</li>
                            <li><img src="{{env('CDN_IMAGE_URL')}}/shoppre.com/cdn/img/svg/Ellipse.svg" >Doorstep delivery in 3–6 business days</li>
                            <li><img src="{{env('CDN_IMAGE_URL')}}/shoppre.com/cdn/img/svg/Ellipse.svg" >Wallet Cashback</li>
                            <li><img src="{{env('CDN_IMAGE_URL')}}/shoppre.com/cdn/img/svg/Ellipse.svg" >Real time online tracking</li>
                        </ul>
                    </div>
                </div>
            </div>
