...
@endsection
<style>
    .section-cguide-m{background-color:#11273b;padding-top:3em;padding-bottom:3em}.section-cguide-m>div>div>span{margin-top:10px}.section-cguide-m .select2-container--default .select2-selection--single{background-color:#11273b!important;border:none;border-radius:4px}.section-cguide-m .select2-container--default .select2-selection--single .select2-selection__rendered{color:#fdf699!important;font-size:22px!important;line-height:34px}.section-cguide-t{background-color:#fafafb}.section-cguide-t .container-tab{background-color:#fff;border-radius:20px}.section-cguide-t .container .div-img{width:350px;box-shadow:0 0 20px rgba(17,39,59,.05);border-radius:10px;background-color:#fff;padding-top:10px;padding-bottom:10px}.section-cguide-t .container .div-img img{width:100%}.section-cguide-t .padding-left{padding-left:30px}.section-cguide-t .tab .nav-tabs{border-bottom:none;position:relative}.section-cguide-t .tab .nav-tabs li{margin-right:60px}.section-cguide-t .tab .nav-tabs li a{font-size:16px;font-weight:600;color:#677582;border-radius:0;margin-right:0;border:none;position:relative;transition:all .5s ease 0s}.section-cguide-t .tab .nav-tabs li a:before{content:"";width:60%;height:2px;background:rgba(0,0,0,.2);position:absolute;bottom:5px;left:20px;background:#e85151;transform:scale(0);transition:all .7s ease 0s}.section-cguide-t .tab .nav-tabs li a:after{content:"";background:#507dbc;margin:0 auto;position:absolute;bottom:2px;left:0;right:0;transform:scale(0);transition:all .7s ease 0s}.section-cguide-t .tab .nav-tabs li.active a,.section-cguide-t .tab .nav-tabs li.active a:focus,.section-cguide-t .tab .nav-tabs li.active a:hover{border:none;color:#e85151}.section-cguide-t .tab .nav-tabs li a:hover:after,.section-cguide-t .tab .nav-tabs li a:hover:before,.section-cguide-t .tab .nav-tabs li.active a:after,.section-cguide-t .tab .nav-tabs li.active a:before{transform:scale(1)}.section-cguide-t .tab .tab-content{background:#fff;font-size:14px;color:#677582;line-height:26px;border-top:1px solid rgba(146,156,165,.2)}.section-cguide-t .tab .tab-content h3{font-size:24px;margin-top:0}.section-cguide-t form button{width:210px;height:40px;color:#fff;font-weight:600;border-radius:60px!important;background-color:#e85151;transition:.6s;margin-bottom:50px}.section-cguide-t form button:hover{-webkit-box-shadow:0 5px 20px 0 rgba(0,0,0,.3);-moz-box-shadow:0 5px 20px 0 rgba(0,0,0,.3);box-shadow:0 5px 20px 0 rgba(0,0,0,.3);color:#fff}.section-cguide-t .tab-content .div-weight-img{border:1px solid rgba(146,156,165,.1);background-color:#fafafb;padding-left:3em;margin-top:40px;padding-bottom:10px}.section-cguide-t .tab-content .div-weight-img img{width:60%}@media only screen and (max-width:600px){.section-cguide-t .tab .nav-tabs li{margin-right:15px}.section-cguide-t .container .div-img{width:300px;margin-top:15px}}
</style>
                                ...
                                <div class="row">
                                    <div class="col-md-5 col-sm-6 col-xs-12" id="price-cal-btn-margin">
                                        <a class="btn btn-price-cal-v-address"
                                           href="https://www.shoppre.com/customer/register">Get
                                            a
                                            Virtual Address</a>
                                    </div>
                                    <div class="col-md-5 col-sm-6 col-xs-12" id="price-cal-btn-margin">
...
@section('js_script')
    ...
    <script type="text/javascript">
        $(document).ready(function(){$(".select2").select2(),$("#shipping").validate({rules:{country:{required:!0},weight:{required:!0},unit:{required:!0}},messages:{country:{required:"Please select country"},weight:{required:"Please enter weight to calculate."},unit:{required:"Please select unit of weight."}},submitHandler:function(e){var t=$("select[name='country']").val(),i=$("input[name='weight']").val(),r=$("input[name='unit']:checked").val(),a=$("input[name='type']:checked").val(),n=$("input[name='scale']:checked").val(),s=$("input[name='length']").val(),u=$("input[name='width']").val(),o=$("input[name='height']").val(),c=$("input[name=_token]").val();return $("#calc_load").show(),$("#calc_error").hide(),$("#price-cal").hide(),jQuery.ajax({url:"/calculate-shipping",type:"POST",data:{_token:c,country:t,weight:i,unit:r,type:a,length:s,width:u,height:o,scale:n},success:function(e){if(console.log(e),$("#calc_load").hide(),"1"==e.error)$("#calc_error").css("display","block");else{var t="",i="",r="";e.prices.map(function(e){t=Math.round((100-e.discount)/100*e.amount),i=e.amount,r=e.discount,' <tr> <td> <h1 class="header1" style="color: #507dbc;"><i class="fa fa-rupee"></i> <span>'+(100-e.discount)/100*e.amount+'</span> </td> <td><h6 class="header6 p-color-cement"><span class="striked"><i class="fa fa-rupee"></i> <span><strike>'+e.amount+'</strike></span></span></h6> </td><td class="discount"> <h6 class="header6" style="color: red"> <span>'+e.discount+"</span>% OFF</h6></td> </tr>",$("#final-price").text("₹"+t),$("#actual-amount").text("₹"+i),$("#discount").text(r),$("#price-cal-slide-down").slideDown()})}}}),!1}}),$("#form_quote").validate({rules:{state:{required:!0},city:{required:!0},pin:{required:!0},type:{required:!0},weight:{required:!0},unit:{required:!0},email:{required:!0,email:!0},mobile:{required:!0}},messages:{state:{required:"Please select state"},city:{required:"Please enter city"},pin:{required:"Please enter PIN"},weight:{required:"Enter package weight."},email:{required:"Enter your email address to contact."},mobile:{required:"Enter your mobile number to contact."}},submitHandler:function(e){return $("#quote_load").show(),jQuery.ajax({url:"/qoute/submit",type:"POST",data:$("#form_quote").serialize(),success:function(e){$("#form_quote")[0].reset(),$("#quote_load").hide(),$("#quote_submit").hide(),$("#quote_result").show()},error:function(e,t,i){$("#form_quote")[0].reset(),$("#quote_load").hide(),$("#quote_error").show(),$("#quote_submit").hide()}}),!1}})}),$("#select_iso").change(function(){0!=$(this).val().length&&(window.location="/cguide/"+$(this).val())}),$.ajax({url:"https://api.myip.com",headers:{"Access-Control-Allow-Headers":"Content-Type","Access-Control-Allow-Origin":"*"},type:"GET",dataType:"json",success:function(e){var t=e.country,i="",r="United Arab Emirates";if("India"!=t){i="to "+t;r=t}jQuery.ajax({url:"/calculate-shipping",type:"POST",data:{country:r,weight:.5,unit:"kg",type:"nondoc",length:"",width:"",height:"",scale:"",origin:"home_page"},success:function(e){if(console.log(e),"1"==e.error);else{var t="";e.prices.map(function(e){t=Math.round((100-e.discount)/100*e.amount),$("#prices").text(t),$("#country").text(i)})}}})}});
    </script>
@endsection
