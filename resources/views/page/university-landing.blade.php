    ...
    <section class="bg-christmas-landing-page">
        <div class="container no-padding">
           <div class="col-md-2 div-snow">
               <img src="{{env('CDN_IMAGE_URL')}}/shoppre.com/cdn/img/images/plane_earth.png')}}" alt="">
           </div>
           <div class="col-md-8 col-xs-12" >
               <center>
                   <img src="{{env('CDN_IMAGE_URL')}}/shoppre.com/cdn/img/images/plane_earth.png')}}" alt="" class="img-new-year">
            ...
            <div class="col-md-2 div-newyear">
                <img src="{{env('CDN_IMAGE_URL')}}/shoppre.com/cdn/img/images/graphic_parsal.png')}}" alt="">
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-2 col-md-offset-1 col-xs-12">
                    <a href="tel:+91-8277919191" class="c-image">
                        ...
                        <img src="{{env('CDN_IMAGE_URL')}}/shoppre.com/cdn/img/images/christmas-contact.png')}}" alt="contact shoppre">
                    </a>
                </div>
            </div>
                ...
                <div class="row text-center">
                    ...
                    <div class="col-sm-4">
                        <div class="panel ps-img-rounded">
                            <center>
                                <br/>
                                <img src="{{env('CDN_IMAGE_URL')}}/shoppre.com/cdn/img/images/graphic_parsal.png" alt="" style="height: 64px;">
                                <br/>
                                <br/>
                                <span>Step 1</span>
                    ...
                    <div class="col-sm-4">
                        <div class="panel ps-img-rounded">
                            <br>
                            <img src="{{env('CDN_IMAGE_URL')}}/shoppre.com/cdn/img/svg/online-shop-un.svg" alt="">
                            <br/>
                            <br/>
                            <span>Step 2</span>
