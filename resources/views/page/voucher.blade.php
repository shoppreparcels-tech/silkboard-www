            ...
            <div class="row">
                ...
                <div class="col-md-12 col-xs-12">
                    ...
                    <div class="col-md-6 col-xs-12 col-sm-6"><br><br>
                        <img src="{{env('AWS_CLOUD_FRONT')}}/img/images/flipkart-international-shipping-voucher.png" alt="" style="width:100%;">
                    </div>
...
@section('js_script')
    <script type='text/javascript'>
        var pubID="54240CL48886";!function(e,n){var t=document.createElement("script");t.type="text/javascript",t.async=!0,t.src=("https:"==document.location.protocol?"https://cdn0.cuelinks.com/js/":"http://cdn0.cuelinks.com/js/")+"cuelinksv1.js",document.getElementsByTagName("body")[0].appendChild(t)}(),$(document).ready(function(){$("#diwali_coupon").validate({rules:{email:{required:!0}},messages:{},submitHandler:function(e){var n=$("input[name='email']").val(),t=$("input[name='pnumber']").val(),a=$("[name='country_code']").val(),c=$("input[name=_token]").val();jQuery.ajax({url:"new-year-offer",type:"POST",data:{_token:c,email:n,pnumber:t,cnumber:a},success:function(e){var c="{{env('PREFIX')}}www.{{env('DOMAIN')}}/customer/register?email="+n+"&c_code="+a+"&PN="+t;console.log(e),window.location.href=c}})}})});
    </script>
@endsection
