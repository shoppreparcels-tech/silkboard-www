...
@section('description', 'Shoppre offers Door to Door courier service to ' .ucfirst(trans($country)).
...
@section('content')
  <section class="timeline">
      <div class="container">
          ...
          <br>
          <h4>Ship from India to {{ucfirst(trans($country))}}. Shoppre offers DOOR TO DOOR courier to
              {{ucfirst(trans($country))}} from ANY part of India. The charges are cheapest in India for sending
              courier to {{ucfirst(trans($country))}} . This is by a courier company which is the best in industry
              for parcel services to {{ucfirst(trans($country))}} .</h4>
      </div>
  </section>
@endsection