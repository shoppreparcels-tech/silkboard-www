...
@section('description', 'A list of latest queries how how to do international shipping from India to Hawaii. Online support. Door delivery. Calculate quick & easy online your shipping costs.')
        ...
        <div class="container fst-service">
            <div class="row">
                <div class="col-md-8 col-xs-12">
                    <h2 class="header2 p-color-cement-dark font-weight-900 txt-align">The most reliable and fast shipping from Hawaii to Hawaii</h2>
                </div>
