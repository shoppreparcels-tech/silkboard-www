...
@section('content')
    ...
    <section class="seo-sec">
        <div class="container">
            ...
            <h2 class="f-s-18 f-c-d-gray f-w-8">7. What is the best way to ship Jewelry from India to South Africa?</h2>
            ...
            <h2 class="f-s-18 f-c-d-gray f-w-8">8. Does Flipkart/Amazon.in/Club Factory ship to South Africa?</h2>
