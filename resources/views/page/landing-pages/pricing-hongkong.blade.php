...
@section('title', 'Courier Charges Per Kg To Hong Kong from India | ShoppRe.com')
@section('description', 'Save up to 80% on International courier and Parcel delivery services to Hong Kong from India. Book a Courier Now.')
...
@section('content')
        ...
        <div class="container">
            ...
            <div class="col-sm-7 col-xs-12 no-pad">
                <div class="col-md-12 col-xs-12 no-pad">
                    <h1 class="p-color-white header-spacing d-header-text">Courier Rates to Hong Kong
                        <br></h1>
                    <h1 class="header1 p-color-white header-spacing">Starting from ₹1501/-</h1>
                ...
                <form action="" method="post" id="ics_lp">
                    ...
                    <div class="formFrame " id="diwali-couponcode1" style="padding: 10px 20px !important;">
                        ...
                        <div class="form-group text-center div-align-items-l">
                            ...
                            <a href="https://api.whatsapp.com/send?phone=918277919191&text=Hi%20ShoppRe%20Team,%20%20I%27m%20looking%20for%20Courier%20Quote%20from%20India%20to%20Hong-Kong" target="_blank" class="btn btn-s-b btn-a-l btn-b-g">Message us on WhatsApp</a>
                            {{--</button>--}}
                        </div>
    ...
    <section class="seo-sec">
        <div class="container">
            <center>
                <br>
                <h1 class="f-s-30 f-c-d-gray font-weight-900"> <span class="f-c-blue">International Courier From India to Hong Kong</span>,
                    <br>Courier To Hong Kong From India & Save up to 80% on Shipping</h1>
            </center>
            <br>
            <p class="f-s-22 f-c-d-gray">Fast & Cheap Courier Services | Online Tracking, Express Delivery‎</p>
            <br>
            <p class="f-s-18 f-c-gray">ShoppRe extends its gratitude to the people of Hong Kong, the world’s fourth-most densely populated region with a
                population of about 7.3 million people of different nationalities, and the most attractive spot to many business people.
            </p> <br>
            <p class="f-s-18 f-c-gray">ShoppRe helps you ship your courier to the favorite city for tourism in the world which retains its position as the most visited city in the world for
                eight consecutive years such that your parcels arrive on time and at an affordable and cheap courier rate and enabling you to reduce your per-kg cost on your bulk shipment.
            </p> <br>

            <h2 class="f-s-20 f-c-d-gray f-w-8">Go through the following FAQs for better insight and more understanding of all the questions that had arisen in your mind so far.</h2>
            <br>
            <h2 class="f-s-18 f-c-d-gray f-w-8">1. Why should I rely on ShoppRe for shipping services?</h2>
            <p class="f-s-16 f-c-gray">You can rely on ShoppRe for its services like Package Forwarding, Shop and Ship services, Personal Shopper services like
                Assisted Purchases, Consolidation services, Warehousing, etc., It would be a one-stop destination for ALL the shipping related solutions and would
                make your shipping process a burden-free and hassle free while you can just sit back and relax as they would take care of your shipment from end to end.
             </p> <br>

            <h2 class="f-s-18 f-c-d-gray f-w-8">2. Can I ship fragile items from India to Hong Kong?</h2>
            <p class="f-s-16 f-c-gray">Any kind of goods except those which are in our prohibited and restricted list can be shipped.
                For any fragile items, you would need to make sure it has been packed properly as we will not be responsible for any damage caused by inappropriate packaging.
            </p> <br>
            ...
            <p class="f-s-16 f-c-gray">Yes, ShoppRe collects all your parcel/courier from any address all over India. Even if it is on the 4th floor of a
                building with a broken elevator, we will try our best to help you during the collection. Just let us know in advance if there is any restriction
                for the collection to be made. Collection restriction could apply if we hire our trusted partners to complete the collection process.
            </p> <br>

            <h2 class="f-s-18 f-c-d-gray f-w-8">4. On what basis is the cost evaluated?</h2>
            <p class="f-s-16 f-c-gray">ShoppRe evaluates its cost based on both volumetric and actual weight. (whichever is higher) as a tactical decision
                in response to comparing market situations. The benefit of this is that the shipping costs can be cut down to almost half when you have
                multiple packages, as ShoppRe consolidates your multiple packages and ship it as a single package. Due to which the cost you need to
                pay on each package will be avoided and hence pay just on the total weight of the consolidated package. And an additional benefit is
            ...
            <p class="f-s-16 f-c-gray">ShoppRe provides you with the facility of consolidation where all your packages from different sources
                will be collected and packed into single package and finally discard it after providing a 20 days free storage through which
                you can reduce your per-kg cost and also the price and the quantity (weight) of the package is inversely proportional to each other.
            </p> <br>

            <h2 class="f-s-18 f-c-d-gray f-w-8">6. What is the best way to ship household items from India?</h2>
            <p class="f-s-16 f-c-gray">ShoppRe would be the absolute answer for it. ShoppRe helps you ship your household stuffs with very cheap shipping rates alongside the
                best quality services and fast delivery anywhere in Qatar from India along with the reduced per-kg cost on your package.
            </p> <br>
        </div>
        <br>
    </section>
