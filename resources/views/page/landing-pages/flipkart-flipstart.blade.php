...
@section('title', 'Flipkart Flipstart Days Sale in 2019 | ShoppRe')
@section('description', '')
@section('keywords', 'flipkart, flipstart days')
...
{{--           </div>--}}
           ...
           <a href="https://api.whatsapp.com/send?phone=917338208403&text=Flipkart%20FLIPSTART%20Days%20Sale"
...
{{--                    personal care items, and much more. The sale features many novel and attractive offers like No Cost EMI on credit/debit cards, 10% off for--}}
{{--                    HDFC cardholders, exchange offers, buyback guarantees and much more along with enormous discounts on all products.--}}
{{--                </p>--}}
{{--                <br>--}}
{{--                <p class="header4 p-color-cement">--}}
