...
@section('title', 'Courier Charges Per Kg To Saudi Arabia from India | ShoppRe.com')
@section('description', 'Send International courier to Saudi Arabia from India. Cheap shipping rates. Door-to-door delivery. Book a Courier Now.')
...
@section('content')
        ...
        <div class="container">
            ...
            <div class="col-sm-7 col-xs-12 no-pad">
                <div class="col-md-12 col-xs-12 no-pad">
                    <h1 class="p-color-white header-spacing d-header-text">Courier Rates to Saudi Arabia
                        <br></h1>
                    <h1 class="header1 p-color-white header-spacing">Starting from ₹1517/-</h1>
                ...
                <div class="col-md-12 col-xs-12 no-pad" style="margin-bottom: 14px;">
                    <center>
                        <a href="{{route('schedulePickup.Index')}}" class="btn btn-s-r btn-b-r btn-a-l" title="Create Pickup Request Saudi Arabia">Schedule Pickup</a>
                        <a href="{{route('pricing')}}" class="btn btn-l btn-s-b btn-b-b btn-a-l" title="Shipping Rates Saudi Arabia">Estimate</a>
                    </center>
                    <br>
                ...
                <form action="" method="post" id="ics_lp">
                    ...
                    <div class="formFrame " id="diwali-couponcode1" style="padding: 10px 20px !important;">
                        ...
                        <div class="form-group text-center div-align-items-l">
                            ...
                            <a href="https://api.whatsapp.com/send?phone=918277919191&text=Hi%20ShoppRe%20Team,%20%20I%27m%20looking%20for%20Courier%20Quote%20from%20India%20to%20Saudi-Arabia" target="_blank" class="btn btn-s-b btn-a-l btn-b-g">Message us on WhatsApp</a>
                            {{--</button>--}}
                        </div>
    ...
    <section class="seo-sec">
        <div class="container">
            <center>
                <br>
                <h1 class="f-s-30 f-c-d-gray font-weight-900"> <span class="f-c-blue">International Courier From India to Saudi Arabia</span>,
                    <br>send a parcel to saudi arabia, door to door shipping
                </h1>
            </center>
            <br>
            <p class="f-s-22 f-c-d-gray">BEST COURIER SERVICES FROM INDIA TO SAUDI ARABIA</p>
            <br>
            <p class="f-s-18 f-c-gray">ShoppRe would be the best, cheap, reliable and fast shipping from India to courier all your stuff.
                <br>
                ShoppRe, a comprehensive solution to companies, traders and individuals for taking care of their International Courier needs,
                extends its warmest wishes and regards to all the people out there at Saudi!
                With ShoppRe, get the best Courier rates and personalized services to get your parcels delivered through the best courier
                network for fast and safe courier delivery to Saudi within just 3-6 working days.
            </p> <br>
            <h2 class="f-s-18 f-c-d-gray f-w-8">And it is more obvious that we can’t and don’t rely on an unknown company to handle our parcel.
                But here are the reasons why you can rely on ShoppRe. Go through the following:
            </h2>
            <br>
            <h2 class="f-s-18 f-c-d-gray f-w-8">1. What is the best shipping company to ship internationally? Why should I rely on ShoppRe?</h2>
            <p class="f-s-16 f-c-gray">ShoppRe doesn’t ask for ANY upfront payment while scheduling your pickup or dropping off the package.
                And if you are worried about the damage to your goods during the transit, there’s no need to worry as we schedule your couriers with the best courier
                partners i.e DHL/FedEx, etc. And DHL/FedEx has strict
                guidelines to ensure the safety of your goods and if by any chance, the damage is made in regards to our fault, then
                ShoppRe refunds the entire amount (if there are any supporting proofs).
            </p> <br>

            <h2 class="f-s-18 f-c-d-gray f-w-8">2. How safe and reliable is it to ship textiles/garments from India to Saudi?</h2>
            <p class="f-s-16 f-c-gray">Shipping garments from India to Saudi through ShoppRe is one of the best resolutions as it is one of the leading Shipping Companies from India on
                which you can completely rely on for its best quality services, cheap shipping rates, amazing consolidation and relocation services, and exclusive offers.
            </p> <br>

            <h2 class="f-s-18 f-c-d-gray f-w-8">3. Are the parcels collected from my home in India for Relocation/Package Forwarding?</h2>
            <p class="f-s-16 f-c-gray">Yes, ShoppRe collects all your parcel/courier from any address all over India. Even if it is on the 4th floor of a building with a
                broken elevator, we will try our best to help you during the collection. Just let us know in advance if there is any restriction for the
                collection to be made. Collection restriction could apply if we hire our trusted partners to complete the collection process.
            </p> <br>
            <h2 class="f-s-18 f-c-d-gray f-w-8">4. How to courier Indian handicrafts cheaply?</h2>
            <p class="f-s-16 f-c-gray">ShoppRe would be the absolute answer for it as it constantly strives and aims for customer satisfaction and cheap and affordable rates by
                reducing almost half of its shipping rates and providing exclusive offers along with the best quality services without compromising on any of the things
                alongside adding the beauty to your entire house/office or any place for that matter with the mesmerizing looks of the Indian handicrafts.
            </p> <br>

            <h2 class="f-s-18 f-c-d-gray f-w-8">5. What is the best way to ship Indian Jewelry to Saudi?</h2>
            <p class="f-s-16 f-c-gray">ShoppRe understands that the connection between jewelry and women is so deep that every woman
                considers her makeover incomplete without embracing some traditional jewelry that adds luster to her entire personality.
                Whether it's a wedding ceremony or a festival, a woman truly sparkles if adorns cultural ornaments, which India is famous for.
                ShoppRe helps you ship your favorite Indian fancy/traditional jewelry except for precious stones like gold, silver,
                diamond, etc that makes you look extra beautiful and add some astonishing look to the entire event/party at very affordable prices.
            </p> <br>

            <h2 class="f-s-18 f-c-d-gray f-w-8">6. Can I ship stuff from Amazon.in/ Flipkart/Myntra to Saudi?</h2>
            <p class="f-s-16 f-c-gray">The answer is no. But ShoppRe allows you to shop from any of your favorite Indian online stores and
                handles the burden of shipping them to your doorstep by taking care of all the Indian customs while you can just sit back and relax.
            </p><br>
            <h2 class="f-s-18 f-c-d-gray f-w-8">7. Will automated products be able to ship to Saudi?
            </h2>
            <p class="f-s-16 f-c-gray">Definitely yes! ShoppRe helps you ship automated products like engines which are less than 70 kg and whose value does not exceed INR 20,000 within just 3-6 business
                days at very affordable prices. However, if the value exceeds INR 20,000 and is more than 70 Kgs, the products can be shipped with certain documentations and manageable customs at the destination.
           </p> <br>
        </div>
        <br>
    </section>
