...
@section('title', 'Shipping from India to East & West Coast, USA | ShoppRe.com')
@section('description', 'Hassle-free Shipping from India to East & West Coast. Great Value At Lowest Price. We Provide Easy & Best service Ever.')
@section('keywords', 'shipping from india to west cost, east, usa, united states of america, california, oregon, washington, alaska, courier service')

@section('css_style')

    <link rel="canonical" href="https://www.shoppre.com/shipping-from-india-to-usa/east-west-coast" />

    <meta property="og:title" content="Ship Goods from India to East/West Coast of the United States | Get ₹200 Off"/>
    <meta property="og:type" content="website"/>
    <meta property="og:url" content="https://www.shoppre.com/shipping-from-india-to-usa/east-west-coast"/>
    ...
    <meta property="og:image:alt" content="India to West Coast" />
    <meta property="og:description" content="Flexible, safe and easy. Trust ShoppRe for Fast International Shipping to West Coast of the United States. Get a Quote Today. Duty & Tax Information."/>
    <meta property="og:site_name" content="ShoppRe West Coast"/>
        ...
        <div class="container no-padding">
           <div class="col-md-12 col-xs-12 no-padding">
               ...
               <center>
                   ...
                   <p class="f-s-30 f-c-white f-w-9 ">on your First Shipment to East/West Coast from India </p>
...
{{--                   <p class="f-s-12 f-c-l-gray f-w-8">Shipping services to Caribbean from India</p>--}}
        ...
        <div class="container fst-service">
            <div class="row">
                <div class="col-md-8 col-xs-12">
                    <h2 class="header2 p-color-cement-dark font-weight-900 txt-align">The most reliable and fast shipping from India to East & West Coasts</h2>
                </div>
                <div class="col-md-2 col-md-offset-1 col-xs-12 text-center">
                    <a href="https://api.whatsapp.com/send?phone=918277919191&text=I%27m%20Looking%20for%20Shipping%20Service%20to%20East/West-Coast,%20USA%20from%20India" target="_blank" title="Click to WhatsApp">
            ...
            <div class=" col-md-12 no-pad"><br>
                <center>
                <h2 class="p-color-cement-dark f-w-9 font-30">Low Cost Shipping from India to East and West  Coasts</h2>
                </center>
                <br>
                <h4 class="f-s-20 f-c-gray f-w-9">Choose ShoppRe for international shipping from India to East and West Coasts as we offer the cheapest
                    and the best way to send your courier from India to USA with our trusted courier partners.
                </h4>
                <br>
                <p class="header4 p-color-cement">Many Indians have been calling East and West Coasts of the USA their homes. Good education and job
                    opportunities drive the Indian diaspora here to reside forever. There are also many Indian communities to have a feeling of home and stay
                    connected with the cultural roots of their homeland.
                </p><br>
                <p class="header4 p-color-cement">Lots of festivals like Holi, Navratri, and Diwali are celebrated with enthusiasm and many locals also take part in them to experience Indian heritage. And a lot of
                    Indians do online shopping from India as well. At ShoppRe we provide the cheapest shipping from India and you can shop from any Indian shopping portal and ship through us in an effortless way.
                </p>
                <br>
                <h4 class="f-s-20 f-c-gray f-w-9"><i>Get special discount of ₹200/- Off on your first international shipment to East/West Coasts, use code: FRST50</i></h4>
                <br>
                <br>
                        ...
                        <div class="calculator cal_block" style="padding: 04px 04px 04px !important; ">
                            ...
                            <form class="calc-form ng-pristine ng-valid ng-submitted" id="shipping" novalidate="novalidate">
                                ...
                                <div class="form-group">
                                    <label class="col-sm-12">Check your shipping cost from India to East/West Coasts</label>
                                    <div class="col-sm-12">
    ...
    <section class="chris-benefits">
        <div class="container" >
            ...
            <h2 class="p-color-cement-dark f-w-9 font-18">1. How to send courier from India to East and West Coasts?</h2>
            ...
            <br>
            <h2 class="p-color-cement-dark f-w-9 font-18">2. How to book a Rakhi from Amazon and send to East and West Coasts?</h2>
            <p class="p-color-cement f-w-9 font-9">You can buy rakhi online from any Indian shopping website through Shoppre. Just sign up and use the virtual
                shipping address at the time of check out, and when your package reaches us, you pay low-cost shipping and we ship it to your address abroad and you get your order within 3-6 days.
            </p>
            <br>
            <h2 class="p-color-cement-dark f-w-9 font-18">3. How to buy things from India and ship to East and West Coasts?</h2>
            <p class="p-color-cement f-w-9 font-9">You can do online shopping in India from any Indian shopping website through Shoppre. Sign up and use the virtual shipping
                address at the time of check out, and when your package reaches us, you pay low-cost shipping and we ship it to your address abroad and you get your order within 3-6 days.
            </p>
            <br>
            <h2 class="p-color-cement-dark f-w-9 font-18">4. How we can order online from India to East and West Coasts?</h2>
            <p class="p-color-cement f-w-9 font-9">You can order online from any Indian shopping website through Shoppre. Just sign up and use the virtual shipping address at the time of check out,
            ...
            <br>
            <h2 class="p-color-cement-dark f-w-9 font-18">5. How long does shipping from India to East and West Coasts take?</h2>
            <p class="p-color-cement f-w-9 font-9">Once your package is consolidated, packed and all set at our warehouse, and we receive your request to ship,
                then it just takes 3-6 working days to ship your package to the USA or ANYWHERE in the world
            </p>
            <br>
            <h2 class="p-color-cement-dark f-w-9 font-18">6. What are the courier charges from India to East and West Coasts?</h2>
            <p class="p-color-cement f-w-9 font-9">We have the cheapest way of shipping by offering up to 80% less shipping cost and the international courier to East and West Coasts, USA starts at just ₹1449/-.
