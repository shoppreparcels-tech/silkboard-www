...
@section('title', 'Celebrate Diwali')
...
@endsection
@section('content')
    <section class="first-time-shipment header-section">
    ...
    <section >
        <div class="container fst-service" style="margin-top: 36px;">
            ...
            <div class="row text-center">
                <div class="col-sm-12 col-xs-6 col-md-3 zoom">
                    <div class="shopandship onam-prod-pic">
                            <img class="img-product" src="{{asset('img/images/pattu-pavadai-girls-onam-dress.png')}}" alt="signup shoppre">
                        ...
                        <div class="check-price-padd">
                            <a href="http://www.malabarshopping.com/kids-collections/check-pattu-pavadai" target="_blank"> <span class="elementor-icon-list-icon">
                                <button class="btn btn-s-r btn-b-r btn-h-40">Check Price</button>
                                </span>
                            </a>
                        </div>
                    </div>
                ...
                <div class="col-sm-4 col-xs-6 col-md-3 zoom">
                    <div class="shopandship onam-prod-pic" >
                            <img class="img-product" src="{{asset('img/images/balaramapurami-unakkupaavu-handloom-women-saree-kerala.png')}}" alt="signup shoppre">
                        <div class="no-pad Rakhi-mid-div mar-t-10 f-s-16" style="padding-top: 5px !important;font-weight: normal">
                            Balaramapuram Saree
                        </div>
                        <div class="check-price-padd">
                ...
                <div class="col-sm-4 col-xs-6 col-md-3 zoom">
                    <div class="shopandship onam-prod-pic" >
                            <img class="img-product" src="{{asset('img/images/black-kara-double-mundu-kerala-traditional-dress-for-men.png')}}" alt="signup shoppre">
                        <div class="no-pad Rakhi-mid-div mar-t-10 f-s-16" style="padding-top: 5px !important;font-weight: normal">
                ...
                <div class="col-sm-4 col-xs-6 col-md-3 zoom">
                    <div class="shopandship onam-prod-pic" >
                            <img class="img-product" src="{{asset('img/images/onapudava-off-white-dhoti-kasavu-for-men-kerala.png')}}" alt="signup shoppre">
                        <div class="no-pad Rakhi-mid-div mar-t-10 f-s-16" style="padding-top: 5px !important;font-weight: normal">
                            Golden Double Dothi
                        </div>
                        <div class="check-price-padd">
                ...
                <div class="col-sm-4 col-xs-6 col-md-3 zoom">
                    <div class="shopandship onam-prod-pic" >
                            <img class="img-product" src="{{asset('img/images/kerala-indian-state-onam-fancy-dress-costume-for-boys.png')}}" alt="signup shoppre">
                        <div class="no-pad Rakhi-mid-div mar-t-10 f-s-16" style="padding-top: 5px !important;font-weight: normal">
                            Onam Dress For Boys
                        </div>
                        <div class="check-price-padd">
