...
@section('title', 'AJIO | WEEKEND BINGE SALE (20-30% Off) | Ship with ShoppRe')
...
@section('content')
    ...
    <section >
        <div class="container fst-service" style="margin-top: 0px;">
            <div class="row">
                <div class="">
                    <h2 class="f-s-18 p-color-cement-dark font-weight-900 txt-center"><span class="f-s-25 f-c-red f-w-9">PAYDAY SALE (1-4 DEC 2019)</span> /
