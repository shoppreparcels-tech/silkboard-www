                ...
                <form action="" method="post" id="ics_lp">
                    ...
                    <div class="formFrame div-form-get-quote" id="diwali-couponcode1">
                        ...
                        <div class="form-group text-center div-align-items-l">
                            ...
                            <a href="https://api.whatsapp.com/send?phone=918277919191&text=Hi%20ShoppRe%20Team,%20%20I%27m%20looking%20for%20Courier%20Quote%20from%20India%20to%20UAE" target="_blank" class="btn btn-s-b btn-a-l btn-b-g">Message us on WhatsApp</a>
                            {{--</button>--}}
                        </div>
        ...
        <div class="container fst-service" style="margin-top: 1px; background: seashell;">
            ...
            <div class="row text-center">
                ...
                <div class="col-sm-4 col-xs-12 col-md-4">
                    <div class="col-sm-12 col-xs-12 col-md-12 shopandship">
                        <div class="col-md-12 col-xs-12 no-pad">
                            <a href="international-courier-charges-india-to-italy-per-kg" target="_blank"> <span class="elementor-icon-list-icon">
                               <i class="fa fa-plane" aria-hidden="true"></i>
                               </span>
                                <span class="elementor-icon-list-text txt-u-l">Italy Courier Rates</span>
                            </a>
                        </div>
                    </div>
                </div>
...
@section('js_script')
    <script>
        $(document).ready(function(){$("#ics_lp").validate({rules:{email:{required:!0}},messages:{},submitHandler:function(e){var a=$("input[name='email']").val(),n=$("input[name='Name']").val(),i=$("input[name='ContactNumber']").val(),o=$("input[name=_token]").val();jQuery.ajax({url:"api-pricing-uae",type:"POST",data:{_token:o,email:a,name:n,contact_no:i},success:function(e){console.log(e),$("#diwali-couponcode1").hide(),$("#diwali-couponcode2").slideDown()}})}})});
    </script>
@endsection
