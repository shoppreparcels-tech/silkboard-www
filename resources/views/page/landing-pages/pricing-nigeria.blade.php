...
@section('title', 'Courier Charges Per Kg To Nigeria from India | ShoppRe.com')
@section('description', 'Send International courier to Nigeria from India. Cheap shipping rates. Door-to-door delivery. Online Tracking. Book a Courier Now.')
...
@section('content')
        ...
        <div class="container">
            ...
            <div class="col-sm-7 col-xs-12 no-pad">
                <div class="col-md-12 col-xs-12 no-pad">
                    <h1 class="p-color-white header-spacing d-header-text">Courier Rates to Nigeria
                        <br></h1>
                ...
                <div class="col-md-12 col-xs-12 no-pad" style="margin-bottom: 14px;">
                    <center>
                        <a href="{{route('schedulePickup.Index')}}" class="btn btn-s-r btn-b-r btn-a-l" title="Create Pickup Request Nigeria">Schedule Pickup</a>
                        <a href="{{route('pricing')}}" class="btn btn-l btn-s-b btn-b-b btn-a-l" title="Shipping Rates Nigeria">Estimate</a>
                    </center>
                    <br>
                ...
                <form action="" method="post" id="ics_lp">
                    ...
                    <div class="formFrame " id="diwali-couponcode1" style="padding: 10px 20px !important;">
                        ...
                        <div class="form-group text-center div-align-items-l">
                            ...
                            <a href="https://api.whatsapp.com/send?phone=918277919191&text=Hi%20ShoppRe%20Team,%20%20I%27m%20looking%20for%20Courier%20Quote%20from%20India%20to%20Nigeria" target="_blank" class="btn btn-s-b btn-a-l btn-b-g">Message us on WhatsApp</a>
                            {{--</button>--}}
                        </div>
    ...
    <section class="seo-sec">
        <div class="container">
            <center>
                <br>
                <h1 class="f-s-30 f-c-d-gray font-weight-900"> <span class="f-c-blue">International Courier From India to Nigeria</span>,
                    <br>send a parcel to nigeria, door to door shipping
                </h1>
            </center>
            <br>
            <p class="f-s-22 f-c-d-gray">SHIPPING MADE EASY WITH SHOPPRE FROM INDIA TO NIGERIA</p>
            <br>
            <p class="f-s-18 f-c-gray">Any of the international service providers can help you ship your package to Nigeria. But not everyone can match your
                expectation on timing, shipment charges, ideal condition of the package, etc.,
                <br> <br>
                But no more to worry! Coz ShoppRe is here with its best pricing that enables you to reduce almost half your per-kg cost on all the international shipments
                and ships all the packages through express shipping after consolidating all the packages of yours personally after repacking and checking if
                there are any damages and couriers the package through the best courier partners maintaining the ideal condition of the package with very strictly guided formulations and principles.
            </p> <br>
            <h2 class="f-s-18 f-c-d-gray f-w-8">Have a look at these FAQs that provides you a baseline for shipping internationally:</h2>
            <br>
            <h2 class="f-s-18 f-c-d-gray f-w-8">1. Does ShoppRe ship to Nigeria?</h2>
            <p class="f-s-16 f-c-gray">ShoppRe provides its services to almost 220+ countries all over the world. And Nigeria is one of the most shipped Countries through ShoppRe among those.
                ShoppRe also provides a door delivery facility that helps you to just sit back and relax while we take the risk.
            </p> <br>

            <h2 class="f-s-18 f-c-d-gray f-w-8">2. Does ShoppRe ship water filters to Nigeria?</h2>
            <p class="f-s-16 f-c-gray">Certainly Yes! ShoppRe helps you ship water filters with the most reliable shipping prices to your doorstep within just 3-6 business days by
                providing you with a door delivery facility through our trusted courier partners with the best quality services.
            </p> <br>

            <h2 class="f-s-18 f-c-d-gray f-w-8">3. Shipping a phone from ShoppRe to Nigeria cost?</h2>
            <p class="f-s-16 f-c-gray">ShoppRe estimates the shipping cost by taking into consideration both the volumetric weight and actual weight enabling you to reduce your per-kg cost to almost half. However,
                only the new phones can be shipped through ShoppRe but not the used phones. The batteries of the new phones will also be first drained off and then shipped due to the Indian customs and regulations.
            </p> <br>
            <h2 class="f-s-18 f-c-d-gray f-w-8">4. What makes ShoppRe unique among the other service providers?</h2>
            <p class="f-s-16 f-c-gray">There are many international courier service providers in the market. But what makes ShoppRe a unique and a stand out thing is, it provides a wide
                variety of shipment choices for the faster and better connections worldwide, including all air and sea services, repackaging, relocation, consolidation, and many other services.
            </p> <br>

            <h2 class="f-s-18 f-c-d-gray f-w-8">5. What are the items that I can/cannot courier from India to Nigeria through ShoppRe?</h2>
            <p class="f-s-16 f-c-gray">ShoppRe helps you ship all the packages except fragile items, food grains, flammable items, alcoholic items, currencies, Animal products, currency notes,
                etc.which can not be shipped through any of the other courier services also due to customs issues. However,
                ShoppRe helps you ship Indian clothing accessories, footwear, Indian Handicrafts, Decor items, water filters, and many more to your doorstep at abroad.
            </p> <br>

            <h2 class="f-s-18 f-c-d-gray f-w-8">6. How to courier Indian clothing accessories to Nigeria?</h2>
            <p class="f-s-16 f-c-gray">Shipping Indian fashion and comfortable clothing accessories would no more be a big deal with ShoppRe as we help you courier all your
                shipments after consolidating into one package also by reducing the per-kg cost to its minimum to your doorstep within just 3-6 days allowing you to just sit back and relax.
            </p><br>
            <h2 class="f-s-18 f-c-d-gray f-w-8">7. How to book a shipment through ShoppRe?
            </h2>
            <p class="f-s-16 f-c-gray">All you have to do is to sign up with ShoppRe and get a unique virtual locker id and use
                that address as your shipping destination whenever you make a purchase with any of your Indian online stores.
                And when the package reaches our destination, we consolidate it, repack it and then ship it as a single package when you have multiple packages from multiple stores.
                <br>
                If you wanna courier, you can avail our pick up services by scheduling a pickup. We facilitate you by arranging
                a doorstep pickup with our trusted local courier partners and dispatch it to your preferred destination.
           </p> <br>
            <h2 class="f-s-18 f-c-d-gray f-w-8">8. Is ShoppRe an International Packers and Movers? Does it provide International Courier Services?
            </h2>
            <p class="f-s-16 f-c-gray">Yes! ShoppRe helps you ship internationally with its best quality services following strict guidelines on its Shipping process.
                It repacks, consolidates and also provides relocation services helping you reduce your International Shipping burden.
                It not only enables you to shop and ship but also provides courier services all over the world with its speedy services that
                dispatch your package to the preferred destination in just 3-6 days.
            </p> <br>
        </div>
        <br>
    </section>
    ...
    <section>
        <div class="container fst-service" style="margin-top: 1px; background: seashell;">
            ...
            <div class="row text-center">
                ...
                </div><div class="col-sm-4 col-xs-12 col-md-4">
                    <div class="col-sm-12 col-xs-12 col-md-12 shopandship">
                        <div class="col-md-12 col-xs-12 no-pad">
                ...
                <div class="col-sm-4 col-xs-12 col-md-4">
                    <div class="col-sm-12 col-xs-12 col-md-12 shopandship">
                        <div class="col-md-12 col-xs-12 no-pad">
                            <a href="international-courier-charges-india-to-philippines-per-kg" target="_blank"> <span class="elementor-icon-list-icon">
                               <i class="fa fa-plane" aria-hidden="true"></i>
                               </span>
                                <span class="elementor-icon-list-text txt-u-l">Philippines Courier Rates</span>
                            </a>
                        </div>
                    </div>
                </div>
...
@section('js_script')
    <script>
        $(document).ready(function(){$("#ics_lp").validate({rules:{email:{required:!0}},messages:{},submitHandler:function(a){var e=$("input[name='email']").val(),n=$("input[name='Name']").val(),i=$("input[name='ContactNumber']").val(),o=$("input[name=_token]").val();jQuery.ajax({url:"api-pricing-usa",type:"POST",data:{_token:o,email:e,name:n,contact_no:i},success:function(a){console.log(a),$("#diwali-couponcode1").hide(),$("#diwali-couponcode2").slideDown()}})}})});
    </script>
@endsection
