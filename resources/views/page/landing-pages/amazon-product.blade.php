...
@section('content')
    ...
    <section >
        <div class="container fst-service" style="margin-top: 0px;">
            <div class="row">
                <div class="">
                    <h2 class="f-s-18 p-color-cement-dark font-weight-900 txt-center">November 2019 Sale: <span class="f-s-25 f-c-red f-w-9">Wedding Store</span> /
        ...
        <div class="container div-ics-border-btm">
            <div class="col-md-12 col-xs-12 no-pad">
                <div class=" col-md-12 col-xs-12 div-ics-prodcts">
                    <br>
                    <p class="f-s-20 f-c-gray txt-center">Best online shops with ShoppRe, Cheap Package Forwarding from India</p>
                    <div class="col-md-6 col-xs-12 ">
                        <ul>
                            ...
                            <li><a href="/ajio-online-shopping">Shop Online on AJIO.com</a></li><br>
