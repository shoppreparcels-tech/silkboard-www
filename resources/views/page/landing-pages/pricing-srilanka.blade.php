...
@section('title', 'Courier Charges Per Kg To Sri Lanka from India | ShoppRe.com')
@section('description', 'Cheapest international courier and Parcel delivery services to Sri Lanka from India. Book a Courier Now.')
@section('keywords', 'lk, sri lanka, courier, shipping services, dhl, cheapest courier from chennai to sri lanka')

@section('css_style')
    <link rel="canonical" href="https://www.shoppre.com/international-courier-charges-india-to-sri-lanka-per-kg" />
    ...
    <script type="application/ld+json">
{
  ...
  "@type": "Organization",
  "name": "ShoppRe.com",
  "alternateName": "Send International Courier From India to Sri Lanka",
  "url": "https://www.shoppre.com/international-courier-charges-india-to-sri-lanka-per-kg",
    ...
    <script type="application/ld+json">
{
  ...
  "description": "international courier from India to Sri Lanka",
  "originAddress": {
    "@type": "PostalAddress",
...
@section('content')
        ...
        <div class="container">
            ...
            <div class="col-sm-7 col-xs-12 no-pad">
                <div class="col-md-12 col-xs-12 no-pad">
                    <h1 class="p-color-white header-spacing d-header-text">Courier Rates to Sri Lanka
                        <br></h1>
                    <h1 class="header1 p-color-white header-spacing">Starting from ₹1406/-</h1>
                ...
                <div class="col-md-12 col-xs-12 no-pad" style="margin-bottom: 14px;">
                    <center>
                        <a href="{{route('schedulePickup.Index')}}" class="btn btn-s-r btn-b-r btn-a-l" title="Create Pickup Request Sri Lanka">Schedule Pickup</a>
                        <a href="{{route('pricing')}}" class="btn btn-l btn-s-b btn-b-b btn-a-l" title="Shipping Rates Sri Lanka">Estimate</a>
                    </center>
                    <br>
                ...
                <form action="" method="post" id="ics_lp">
                    ...
                    <div class="formFrame " id="diwali-couponcode1" style="padding: 10px 20px !important;">
                        ...
                        <div class="form-group text-center div-align-items-l">
                            ...
                            <a href="https://api.whatsapp.com/send?phone=918277919191&text=Hi%20ShoppRe%20Team,%20%20I%27m%20looking%20for%20Courier%20Quote%20to%20Sri%20Lanka" target="_blank" class="btn btn-s-b btn-a-l btn-b-g">Message us on WhatsApp</a>
                            {{--</button>--}}
                        </div>
    ...
    <section class="seo-sec">
        <div class="container">
            <center>
                <br>
                <h1 class="f-s-30 f-c-d-gray font-weight-900"> <span class="f-c-blue">International Courier From India to Sri Lanka</span>,
                    <br>cheap, fast & reliable shipping to sri lanka</h1>
            </center>
            <br>
            <p class="f-s-22 f-c-d-gray">SAFE AND SECURE COURIER FROM INDIA</p>
            <br>
            <p class="f-s-18 f-c-gray">There had always been a situation where you had to pay more than the actual cost for the Indian product at your place.
                No more are such days. Shop and ship the Indian products to your doorstep through ShoppRe by paying the actual cost of it with very
                cheap courier rates and best quality services allowing you to reduce your per-kg cost to almost half with the increased consolidated package weight
            </p> <br>
            <p class="f-s-18 f-c-gray">However, not all the items are on the list due to customs issues. And the shipping rates again will be determined by the area
                which you want to ship and it varies from one place to another.
            </p> <br>

            <h2 class="f-s-20 f-c-d-gray f-w-8">Go through the following FAQs for a better understanding and a clear insight into the working process and procedures of ShoppRe</h2>
            <br>
            <h2 class="f-s-18 f-c-d-gray f-w-8">1. How safe and reliable is it to ship textiles/garments from India to Srilanka?</h2>
            <p class="f-s-16 f-c-gray">Shipping garments from India to Srilanka through ShoppRe is one of the best resolutions as it is one of the leading Shipping Companies from India on which you can
                completely rely on for its best quality services, cheap shipping rates, amazing consolidation and relocation services, and exclusive offers.
             </p> <br>

            <h2 class="f-s-18 f-c-d-gray f-w-8">2. Are the parcels collected from my home in India for Relocation/Package Forwarding?</h2>
            <p class="f-s-16 f-c-gray">Yes, ShoppRe collects all your parcel/courier from any address all over India. Even if it is on the 4th floor of a
                building with a broken elevator, we will try our best to help you during the collection. Just let us know in advance if there is any restriction for
                the collection to be made. Collection restriction could apply if we hire our trusted partners to complete the collection process.
            </p> <br>

            <h2 class="f-s-18 f-c-d-gray f-w-8">3. What is the best way to ship Indian Jewelry to Srilanka?</h2>
            <p class="f-s-16 f-c-gray">ShoppRe understands that the connection between jewelry and women is so deep that every woman considers her makeover incomplete without embracing
                some traditional jewelry that adds luster to her entire personality. Whether it's a wedding ceremony or a festival, a woman truly sparkles if adorns
                cultural ornaments, which India is famous for. <br>
                ShoppRe helps you ship your favorite Indian fancy/traditional jewelry except for precious stones like gold, silver, diamond, etc that makes you
                look extra beautiful and add some astonishing look to the entire event/party at very affordable prices.

            </p> <br>

            <h2 class="f-s-18 f-c-d-gray f-w-8">4. Can I ship stuff from Amazon.in/ Flipkart/Myntra to SriLanka?</h2>
            <p class="f-s-16 f-c-gray">The answer is no. But ShoppRe allows you to shop from any of your favorite Indian online stores and handles the burden of shipping
                them to your doorstep by taking care of all the Indian customs while you can just sit back and relax.
            </p> <br>

            <h2 class="f-s-18 f-c-d-gray f-w-8">5. How to courier Indian handicrafts cheaply?</h2>
            <p class="f-s-16 f-c-gray">ShoppRe would be the absolute answer for it as it constantly strives and aims for customer satisfaction
                and cheap and affordable rates by reducing almost half of its shipping rates and providing exclusive offers along with the
                best quality services without compromising on any of the things alongside adding the beauty to your entire house/office or any place for that matter
                with the mesmerizing looks of the Indian handicrafts.
            </p> <br>

            <h2 class="f-s-18 f-c-d-gray f-w-8">6. Are automated products shipped to Srilanka?</h2>
            <p class="f-s-16 f-c-gray">Definitely yes! ShoppRe helps you ship automated products like engines which are less than 70 kg and whose value does not
                exceed INR 20,000 within just 3-6 business days at very affordable prices. However, if the value exceeds INR 20,000 and is more than 70 Kgs,
                the products can be shipped with certain documentations and manageable customs at the destination
            </p> <br>
            <h2 class="f-s-18 f-c-d-gray f-w-8">7. Are the customs managed by ShoppRe?</h2>
            <p class="f-s-16 f-c-gray">ShoppRe handles and clears all the Indian customs by default but the destination customs can not be estimated and hence can not clear it.
                ShoppRe does not owe any responsibility for the destination’s customs and must be taken care of you.
            </p> <br>
