    ...
    <section>
        <div class="container no-padding">
            ...
            <div class="col-md-6 col-sm-12 col-xs-12">
                <img class="img-responsive" src="{{env('CDN_IMAGE_URL')}}/shoppre.com/cdn/img/images/ics-box-packing.png" alt="">
            </div>
            <div class="col-md-6 col-sm-12 col-xs-12 " style="padding-top: 50px">
                ...
                <div class=" col-md-12 col-xs-12 div-ics-prodcts">
                    <div class="col-md-6 col-xs-6 no-padding">
                        <ul>
                            <li><img src="{{env('CDN_IMAGE_URL')}}/shoppre.com/cdn/img/svg/Ellipse.svg" alt=""> Sarees</li>
                            <li><img src="{{env('CDN_IMAGE_URL')}}/shoppre.com/cdn/img/svg/Ellipse.svg" alt=""> Footwear</li>
                            {{--<li><img src="{{env('CDN_IMAGE_URL')}}/shoppre.com/cdn/img/svg/Ellipse.svg')}}" alt=""> Personal goods</li>--}}
                            <li><img src="{{env('CDN_IMAGE_URL')}}/shoppre.com/cdn/img/svg/Ellipse.svg" alt=""> T-Shirts</li>
                            <li><img src="{{env('CDN_IMAGE_URL')}}/shoppre.com/cdn/img/svg/Ellipse.svg" alt=""> Smartphones</li>
                            <li><img src="{{env('CDN_IMAGE_URL')}}/shoppre.com/cdn/img/svg/Ellipse.svg" alt=""> Kurta & Kurtis</li>
                            <li><img src="{{env('CDN_IMAGE_URL')}}/shoppre.com/cdn/img/svg/Ellipse.svg" alt=""> Jewellery</li>
                        </ul>
                    </div>
                    <div class="col-md-6 col-xs-6 no-padding">
                        <ul style="text-decoration: none; list-style: none">
                            ...
                            <li><img src="{{env('CDN_IMAGE_URL')}}/shoppre.com/cdn/img/svg/Ellipse.svg" alt="">Mobile Phones</li>
                            <li><img src="{{env('CDN_IMAGE_URL')}}/shoppre.com/cdn/img/svg/Ellipse.svg" alt="">Religious Items</li>
                            <li><img src="{{env('CDN_IMAGE_URL')}}/shoppre.com/cdn/img/svg/Ellipse.svg" alt="">& More Products</li>
                        </ul>
                    </div>
                </div>
            </div>
