      ...
      <div class="container">
          <div class="row">
              <div class="col-md-6 story-image">
                  <img class="img-responsive" src="{{env('AWS_CLOUD_FRONT')}}/img/images/about-image.png" alt="ShoppRe About Us">
              </div>
      ...
      <div class="container ">
          <div class="row">
              ...
              <div class="col-md-5 vision-image">
                  <img class="img-responsive" src="{{env('AWS_CLOUD_FRONT')}}/img/images/vision-image.png" alt="">
              </div>
          </div>
      </div>
  </section>
