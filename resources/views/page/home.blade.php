...
{{--    lazyload" src="/img/images/load.gif"  data-src="/img/svg/shipments.svg"--}}
    ...
    <style>
        .grecaptcha-badge{width:70px!important;overflow:hidden!important;transition:all .3s ease!important;left:4px!important}.img-sale{width:200px;height:150px}.grecaptcha-badge:hover{width:256px!important}.cord-header-size{font-size:16px}.box-margin-top{margin-top:18%}.cord-height{height:160px}.arrow-box{position:absolute;bottom:25%;right:40%}.fuid-padding{padding-left:5%;padding-right:5%}.div-shop-ship1>div{padding-top:10px;padding-bottom:10px}.div-shop-ship1>div>p{text-align:center}.div-main .div-add{position:fixed;margin-top:20%;z-index:1}.div-main .div-add1{position:relative;float:right}.div-h-offer{border-radius:15px;background-color:#fff;padding:20px}.div-h-offer>div{padding-top:10px}.h-div{height:40px;overflow:hidden}.img-div{padding-top:10px;overflow:hidden}.des-div{height:150px;overflow:hidden}.des-div-rakhi{height:210px;overflow:hidden}.div-s-br{border-radius:3px;border:1px solid #677582}.h-s-a>div>a>div:hover{background-color:#507dbc;color:#fff;transition:.3s}.h-s-a a:hover{background-color:#507dbc;color:#fff}.vid-s-img{width:100%}.h-sign-up{display:block}.pad-0-40{padding:40px}.pad-0-10{padding-right:5px;padding-left:5px}.pad-0-15{padding-right:15px;padding-left:15px}.offer-img-m{display:none}.offer-img-d{display:block}.pad-l-d{padding:0}.seo-hyperlinks ul{list-style:none}.seo-hyperlinks ul li{font-size:14px;color:#677582;margin-top:5px}.seo-hyperlinks ul li a{color:#677582}@media only screen and (max-width:1024px){.div-add{display:none}.mobile-pickup-block{display:none}.arrow-box{position:absolute;bottom:28px;right:42%}.box-margin-top{margin-top:15%}}@media only screen and (max-width:1280px){.div-add{display:none}.mobile-pickup-block{display:none}}@media only screen and (max-width:600px){#img-p{display:none}.m-l-content{margin-left:45px}.f-s-19{font-size:19px}.mobile-pickup-block{display:block}.h-sign-up{display:none}.pad-0-40{padding:5px}.pad-0-10{padding-right:5px;padding-left:5px}.offer-img-m{display:block}.offer-img-d{display:none}.fuid-padding{padding-left:3%;padding-right:3%}.des-div{height:140px;overflow:hidden}.vid-s-img{width:85px}.pad-0-15{padding:0}.pad-l-d{padding-left:10%}.arrow-box{position:absolute;bottom:28px;right:32%}.box-margin-top{margin-top:35%}}
    </style>
                    ...
                    <div class="panel ">
                        <ul>
                            ...
                            <li><img src="{{env('AWS_CLOUD_FRONT')}}/img/images/chris-circle.png" alt="Great Indian"><span><a
                                        href="/amazon-great-indian-festival-sales-offers-prime-members-shopping-deals-shipping" target="_blank">Amazon.in Great Sale 2020</a></span></li>
