            ...
            <div class="col-md-10 col-xs-12 pad-b-30">
                <div class="slider" id="shippingCard">
                    ...
                    <div class="col-md-3 col-xs-12" style="box-shadow:none !important;margin-bottom: 10px;">
                        ...
                        <div class="des-div-rakhi text-center"><br>
                            <p class="f-s-16 f-c-l-gray f-w-7"><span class="f-s-16 f-c-blue f-w-9">Clothing, Footwear & more</span></p>
                            <br>
                            ...
                            <br>
                            <p class="f-s-16 f-c-l-gray f-w-7">Shop from <span class="f-s-16 f-c-blue f-w-9">Amazon Fashion Sale</span> & Get Delivered Worldwide with us.</p>
                        </div>
                    ...
                    <div class="col-md-3 col-xs-12" style="box-shadow:none !important;margin-bottom: 10px;">
                        ...
                        <div class="des-div-rakhi text-center"><br>
                            <p class="f-s-16 f-c-l-gray f-w-7"><span class="f-s-16 f-c-blue f-w-9">25th - 27th JAN</span></p>
                            <br>
                        ...
                        <div class="col-md-6">
                            <div class="row div-img-row" id="reviews-img">
                                ...
                                <a href="https://www.facebook.com/pg/goshoppre/reviews" target="_blank">
                                    <p class="p-name" style="font-size: 20px; color: #1a0dab">Recommended by 97</p>
                                </a>
                                <br>
