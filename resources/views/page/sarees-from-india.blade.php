...
@section('content')
    ...
    <section>
        <div class="container christmas-service">
            ...
            <br>
            <div class="row">
                <h2 class="header2 p-color-cement-dark font-weight-900 txt-align heading-mobile" style="display: none;">1. Black Solid Ready to Wear Saree</h2>
                <div class="col-md-4 col-xs-12 col-sm-6 image-align-center-mobile">
                    <div class="onam-prod-pic p-b-26">
                        <a href="" target="_blank">
                            <img class="" src="/img/ready-made-saree/women-black-solid-ready-to-wear-saree.jpg" style="width: 250px">
                        </a>
                    </div>
                </div>
                <div class="col-md-8 col-xs-12 col-sm-6">
                    <br>
                    <br>
                    <h2 class="header2 p-color-cement-dark font-weight-900 txt-align heading-hide">1. Black Solid Ready to Wear Saree</h2>
                    <br>
            ...
            <div class="row">
                <div class="col-md-8 col-xs-12 col-sm-6 image-align-center-mobile">
                    <h2 class="header2 p-color-cement-dark font-weight-900 txt-align">2. Bollywood Vogue - Green & Orange Organza Printed Saree
                    </h2>
                    <div class="col-md-4 col-xs-12 col-sm-6 image-align-center-mobile heading-mobile" style="display: none">
                        <div class="onam-prod-pic p-b-26">
                            <a href="" target="_blank">
                                <img class="" src="/img/ready-made-saree/made-to-measure-green-and-orange-organza-printed-saree.jpg" style="width: 250px">
                            </a>
                        </div>
                    </div>
                    <br>
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-xs-12 col-sm-6 image-align-center-mobile">
                    <div class="onam-prod-pic p-b-26">
                        <a href="" target="_blank">
                            <img class="" src="/img/ready-made-saree/grey-solid-viscose-rayon-saree.jpg" style="width: 250px">
                        </a>
                    </div>
                </div>
...
{{--                </div>--}}
                <div class="col-md-8 col-xs-12">
                    <br>
                    <br>
                    <h2 class="header2 p-color-cement-dark font-weight-900 txt-align heading-hide">
                        3. Grey Solid Viscose Rayon Saree
                    </h2>
                    <br>
                    <p style="color: #11273b;font-size: 15px; !important;text-align: justify;">
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-xs-12 col-sm-6 image-align-center-mobile" style="text-align: right">
                    <div class="onam-prod-pic p-b-26">
                        <a href="" target="_blank">
                            <img class="" src="/img/ready-made-saree/tuscan-yellow-ruffle-saree-with-floral-embroidered-crop-top.jpg" style="width: 250px">
                        </a>
                    </div>
                </div>
...
{{--                </div>--}}
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-xs-12 col-sm-6 image-align-center-mobile">
                    <div class="onam-prod-pic p-b-26">
                        <a href="" target="_blank">
                            <img class="" src="/img/ready-made-saree/apple_red_ready_pleated_ruffle_saree_with_3d_flower_embellished_blouse.jpg" style="width: 250px">
                        </a>
                    </div>
                </div>
...
{{--                </div>--}}
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-xs-12 col-sm-6 image-align-center-mobile" style="text-align: right">
                    <div class="onam-prod-pic p-b-26">
                        <a href="" target="_blank">
                            <img class="" src="/img/ready-made-saree/white-ready-to-wear-saree-poly-georgette-saree.jpg" style="width: 250px">
                        </a>
                    </div>
                </div>
