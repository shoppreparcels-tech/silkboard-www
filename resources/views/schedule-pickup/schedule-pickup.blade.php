                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group label-align">
                                ...
                                <div class="row">
                                    <div class="col-sm-4">
                                        <select class="select2 form-control" name="dc_phone_code" id="dc_phone_code">
