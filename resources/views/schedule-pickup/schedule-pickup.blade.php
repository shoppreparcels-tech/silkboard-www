                ...
                <form class="form-horizontal self_form" id="self_form" method="post"
                    ...
                    <div class="row">
                        <div class="col-md-4 col-sm-offset-4">
                            <button type="submit" class="btn btn-block btn-shoppre btn-submit-pickup" style="background-color: #4285f4!important">Confirm Pickup</button>
                        </div>
                    </div>
                    <div class="clearfix"></div>
                </form>
...
@section('js_script')
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            mixpanel.track_links(".btn-submit-pickup", "Click pickup link Home Page", {
