...
<div id="slider1_container" style="position: relative; top: 10px; left: 0px; width: 1400px; height: 380px; overflow: hidden; ">
    ...
    <div u="loading" style="position: absolute; top: 0px; left: 0px;">
        ...
        <div style="position: absolute; display: block; background: url(..{{env('AWS_CLOUD_FRONT')}}/img/loading.gif) no-repeat center center;
    ...
    <div u="slides" style="cursor: move; position: absolute; left: 0px; top: 0px; width: 1400px; height: 380px; overflow: hidden;">
        <div>
            <a href="https://www.shoppre.com/offers/ganesh-chaturthi-shipping-offers-from-india/" target="_blank">
                <img u="image" src="{{env('AWS_CLOUD_FRONT')}}/img/slider-images/img/landscape/ganesh_chaturthi_wishes.jpg"
        ...
        <div>
            <a href="https://www.shoppre.com/offers/ganesh-chaturthi-shipping-offers-from-india/" target="_blank">
                <img u="image" src="{{env('AWS_CLOUD_FRONT')}}/img/slider-images/img/landscape/Ganesh Chaturthi_Home Page Slider.jpg"
                     alt="international-shipping-shoppre"/>
            </a>
        </div>
        ...
        <div>
            <a href="http://bit.ly/save-on-international-shipping" target="_blank">
                <img u="image" src="{{env('AWS_CLOUD_FRONT')}}/img/slider-images/img/landscape/international-shipping-shoppre.png"
                     alt="international-shipping-shoppre"/>
            </a>
        </div>
        <div>
            <a href="https://www.shoppre.com/schedule-pickup?hp-slider-pickup" target="_blank">
                <img u="image" src="{{env('AWS_CLOUD_FRONT')}}/img/slider-images/img/landscape/pickup-from-india.png"
                     alt="pickup Courier from india shoppre"/>
            </a>
        </div>
        <div>
            <a href="https://www.shoppre.com/locker?homeslider" target="_blank">
            <img u="image" src="{{env('AWS_CLOUD_FRONT')}}/img/slider-images/img/landscape/indian-local-virtual-shipping-address.jpg"
    ...
    <style>
        ...
        */
        .jssorb05 div, .jssorb05 div:hover, .jssorb05 .av {
            background: url({{env('AWS_CLOUD_FRONT')}}/img/slider-images/img/landscape/b05.png) no-repeat;
            overflow: hidden;
            cursor: pointer;
        }
    ...
    <style>
        ...
        */
        .jssora12l, .jssora12r, .jssora12ldn, .jssora12rdn {
            ...
            cursor: pointer;
            display: block;
            background: url({{env('AWS_CLOUD_FRONT')}}/img/slider-images/img/landscape/a12.png) no-repeat;
            overflow: hidden;
        }
