                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                                <div class="fl fw product_c" style="height:375px !important;">
                                    ...
                                    <div class="fl fw pos product_img" style="margin-left:0px !important; "
                                         id="secProductImgOffer0-0">
                                        <br>
                                        <a href="{{route('flash-sale.mi5A.index')}}">
                                            <img
                                    ...
                                    <div class="fl fw item_detail"><p class="brand"
                                                                      style="font-size: 14px;margin-right: 5px !important;"
                                                                      id="lblProductBrand0-0">
                                            Brand:Mi {{$sale->slug}}
                                            <br> Starts
                                            At {{Carbon\Carbon::parse($sale->starts_at)->format('d-m-Y ')}}
                                        </p><a href="#"
                                        ...
                                        <a class="fl button " style="margin-left:30%; "
                                           href="{{route('flash-sale.mi5A.index')}}"
