                       ...
                       <a href="{{route('dhl.detail',['id' => $shipment->id])}}">
                            <div class=" col-md-12 shipments-list">
                                ...
                                <div class="col-md-7 col-xs-8">
                                    <h2 class="header4 p-color-cement"> <img src="{{env('AWS_CLOUD_FRONT')}}/img/svg/ic_weight.svg" alt=""> Weight : <span class="p-color-blue"> {{$shipment->weight}} kg</span></h2>
                                    <h2 class="header4 p-color-cement"><img src="{{env('AWS_CLOUD_FRONT')}}/img/svg/ic_rupee.svg" alt=""> Total Charge:<span class="p-color-blue">INR {{$shipment->final_amount}}</span></h2>
                                </div>
                            </div>
                       </a>
                    </div>
                    <div class="col-md-6 rigth-pad">
                        <a href="{{route('dhl.view',['id' => $shipment->id])}}">
                            <div class=" col-md-12 shipments-list">
                                ...
                                <div class="col-md-7 col-xs-8">
                                    <h2 class="header4 p-color-cement"> <img src="{{env('AWS_CLOUD_FRONT')}}/img/svg/ic_weight.svg" alt=""> Weight : <span class="p-color-blue"> {{$shipment->weight}} kg</span></h2>
                                    <h2 class="header4 p-color-cement"><img src="{{env('AWS_CLOUD_FRONT')}}/img/svg/ic_rupee.svg" alt=""> Total Charge:<span class="p-color-blue">{{$shipment->final_amount}}</span></h2>
                                </div>
                            </div>
                        </a>
                    </div>
