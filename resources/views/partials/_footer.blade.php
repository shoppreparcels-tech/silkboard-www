        ...
        <div class="col-md-12 col-xs-12 pad-t-40">
            ...
            <div class="col-md-3 col-lg-3 col-sm-6 col-xs-4 pad-5">
                <ul class="nav-ul">
                    ...
                    <li class="li"><a itemprop="url" class="footer-a" href="{{route('services')}}">Services</a></li>
                    <li class="li"><a itemprop="url" class="footer-a" href="https://blog.shoppre.com/" target="_blank">Blog</a></li>
                    <li class="li"><a itemprop="url" class="footer-a" href="{{route('story.index')}}" target="_blank">Our Story</a></li>
