<footer  style="background-color: #11273b;">
        ...
        <div class="footer-container">
            ...
            <div class="col-md-3 col-lg-3 col-sm-6 col-xs-6 ">
                <ul class="nav-ul">
                    ...
                    <li class="li"><a class="footer-a"  href="#">What's New</a></li>
            ...
            <div class="col-md-3 col-lg-3 col-sm-6 col-xs-6 " >
                <ul class="nav-ul">
                    ...
                    <li class="li"><a class="footer-a"  href="https://in.hotjar.com/s?siteId=623115&surveyId=65096">Earn 1000 Loyalty Points</a></li>
                    <li class="li"><a class="footer-a"  href="https://chrome.google.com/webstore/detail/shoppre-international-shi/kplnmmemlcfmbhbjegagmiiiphghdpch">Install Chrome Extension</a></li>
                </ul>
            </div>
                ...
                <ul class="nav-ul">
                    ...
                    <li>
                        ...
                        <a class="footer-a" href="mailto:support@shoppre.com footer-social-media">
                            <span class="span-color footer-social-media footer-social-media-font" >support@shoppre.com</span>
                        </a>
                    </li>
                    <li>
                        ...
                        <a class="footer-a"  href="https://www.youtube.com/channel/UCCBP1ybWY9spoleKqMgAQaw">
                            <img class="img-connect" src="{{asset('img/svg/shoppre-youtube-video.svg')}}" alt="shoppre youtube video">
                        </a>
                        <a class="footer-a"  href="https://www.facebook.com/goshoppre/">
                            <img class="img-connect" src="{{asset('img/svg/go-shoppre-faceboook.svg')}}" alt="goshoppre facebook">
                        </a>
                        <a class="footer-a"  href="https://twitter.com/Go_Shoppre">
                            <img class="img-connect" src="{{asset('img/svg/shoppre-twitter.svg')}}" alt="@Go_Shoppre twitter">
                        </a>
                        <a class="footer-a"  href="https://www.instagram.com/shoppre_official/?hl=en">
                            <img class="img-connect" src="{{asset('img/svg/shoppre-instagram.svg')}}" alt="shoppre_officia instagram">
                        </a>
                    </li>
                </ul>
            </div>
            ...
            <div class="col-md-3 col-lg-3 col-sm-6 col-xs-12  div-footer-margin">
                <div class="div-btn">
                    ...
                    <div class="col-md-2 col-lg-2 col-xs-2 col-sm-2">
                        <img class="img-footer1" src="{{asset('img/svg/shipping-price-calculator.svg')}}" alt="international shipping pricing calculator">
                    </div>
                ...
                <div class="div-btn">
                    ...
                    <div class="col-md-2 col-lg-2 col-xs-2 col-sm-2" >
                        <img class="img-footer2" src="{{asset('img/svg/sending-courier-abroad.svg')}}" alt="send courier abroad from india">
                    </div>
                    <div class="col-md-10 col-lg-10 col-sm-10 col-xs-10 div-footer-btn"  >
                ...
                <div class="div-btn" id="div-btn">
                    ...
                    <div class="col-md-2 col-lg-2 col-xs-2 col-sm-2 div-footer-btn" >
                        <img class="img-footer" src="{{asset('img/svg/shop-and-ship-india.svg')}}" alt="shop and ship india">
                    </div>
                    <div class="col-md-10 col-lg-10 col-sm-10 col-xs-10 div-footer-btn" >
    ...
    <div class="container" style="padding-bottom: 20px;">
        <center>
            <a href="{{route('home')}}"><img class="img-footer-logo"  src="{{asset('/img/images/shoppre-logo.png')}}" alt="shoppre.com - your global shipping partner from india"></a>
            <p class="footer-rights">© 2018, All Rights Reserved - by <a  class="footer-a" href="#">ShoppRe.com™</a></p>
        </center>
