   ...
   <tbody>
      <tr>
        <td valign="middle">
            ...
            <p>This mail is to inform you that we have received the amount of INR {{number_format($order->grand_total, 2, ".", "")}} for your personal shopper order <a href="{{route('personal.shopper.history')}}"><b>{{$order->reference_number}}</b></a>. We shall now receive your parcels on your behalf. You shall be notified when via email when your packages arrive to your locker.</p>
