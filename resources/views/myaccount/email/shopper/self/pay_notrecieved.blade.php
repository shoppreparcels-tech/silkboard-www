   ...
   <tbody>
      <tr>
        <td valign="middle">
            ...
            <p>This mail is to inform you that we have not yet received the amount of INR {{number_format($order->grand_total, 2, ".", "")}} for your personal shopper order <a href="{{route('shopper.self.history')}}"><b>{{$order->reference_number}}</b></a>. You have chosen Wire Transfer as the mode of payment.
            <br><font color="#ff0000"><b>We had to reject some of your incoming Package(s) (on Cash on Delivery) as we have not yet received your payment. Please note that if we do not receive your payment within 7 days of creating the PS Order, your order will be cancelled.</b></font></p>
