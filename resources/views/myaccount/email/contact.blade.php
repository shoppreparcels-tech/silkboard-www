                ...
                <tr>
                  <td valign="top">
                    <table cellpadding="0" cellspacing="0" width="600" border="0" align="center">
                      <tbody>
                      <tr>
                        <td valign="top" width="500" style="background-color:#ffffff;color:#666666;font-size:15px;text-align:left;padding: 0px 10px 20px 30px;line-height:20px;color: #5e5e5f;border: 1px solid #eee;">
                            <p style="font-size: 32px;color: #1f2533;">Hello Shoppre,</p>
                            <p style="font-size: 18px;">I'm {{$firstname}} {{$lastname}}</p>
                            <p style="font-size: 16px;">Email: {{$email}}</p>
                            <p style="font-size: 16px;">Locker: {{$locker}}</p>
