   ...
   <tbody>
      <tr>
         ...
         <table border="1" style="border-collapse: collapse;font-size: 14px;width: 100%;max-width: 650px;text-align: left;">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="padding: 5px;"><a href="{{route('shipping.queue')}}">{{$package->order_id}}</a></td>
                </tr>
                @endforeach
            </tbody>
         </table>
         @endif
            ...
            <p>For more information about your shipment, sign in to your Shoppre account and view your <a href="{{route('shipping.queue')}}" target="_blank">Queue</a>. We will update the payment details in the <a href="{{route('shipping.queue')}}" target="_blank">Queue</a> once the we have packed the item.</p>
