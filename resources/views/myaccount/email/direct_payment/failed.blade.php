   ...
   <tbody>
      <tr>
        <td valign="middle">
            ...
            <p>This mail is to inform you that transaction amount of <strong>
                    INR {{number_format($amount, 2, ".", "")}} </strong> has been failed.Please try again!</p>
            <br>
            <p>Questions? Please Refer our <a href="https://www.shoppre.com/faq">FAQ</a> to know more!</p>
