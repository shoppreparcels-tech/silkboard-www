            ...
            <tr>
                ...
                <td>
                    @php
                        ...
                        if(time() > $expire){
                            echo '<span class="text-red">'.date('d-m-Y', strtotime($package->received)).' <a href="#" class="tooltipkey text-red" title="This package has exceeded your free storage time limit and is incurring a storage fee."><i class="fa fa-question-circle-o"></i></a></span>';
                        } else {
                ...
                <td>
                    @php
                        switch($package->status){
                            case 'values':
                                echo '<div class="alltab_status action">
                            ...
                            break;
                            case 'review':
                                echo '<div class="alltab_status review">
                                        <i class="fa fa-search"></i>
                                        <span>In Shoppre Review</span>
                                    </div>';
                            break;
                            case 'ship':
                                echo '<div class="alltab_status">
                                        <i class="fa fa-check"></i>
                                        <span>Ready to Ship</span>
                                    </div>';
                            break;
                            case 'return':
                                echo '<div class="alltab_status return">
            ...
            <tr class="collapse" id="{{$package->order_id}}">
                <td class="intable" colspan="8">
                    ...
                    @if($package->status != 'return')
                        ...
                        <a href="#photo_modal_{{$package->id}}" class="btn btn-photo popup-modal" data-package_id="{{$package->id}}">Photos</a>

                        @if($package->type == 'doc')
                        <a href="#doc_modal_{{$package->id}}" class="btn btn-photo popup-modal">Docs</a>
                        @endif
                    ...
                    <form action="{{route('customer.values.change')}}" method="post">
                        ...
                        <div class="col-sm-12">
                            ...
                            <p><a href="#add_note{{$package->id}}" class="popup-modal">Add your notes</a> to the package, this is for your use only, Shoppre will not review this area.</p>
                            @if(!empty($package->info))
                                <div class="alert alert-warning" role="alert">{{$package->info}}</div>
                            @endif
                        </div>
                            ...
                            <div class="optional_services">
                                ...
                                <div class="dropdown">
                                  ...
                                  <ul class="dropdown-menu" aria-labelledby="optional_menu">
                                    <li><a href="#return_send_{{$package->id}}" class="popup-modal">
                                    ...
                                    <li><a href="#split_pack_{{$package->id}}" class="popup-modal">
                                    ...
                                    <li><a href="#abandon_pack_{{$package->id}}" class="popup-modal">
                    ...
                    <div id="add_note{{$package->id}}" class="modal_photo white-popup-block mfp-hide">
                        ...
                        <div class="col-sm-12">
                            ...
                            <form method="post" action="{{route('customer.package.note')}}">
                                ...
                                <input type="hidden" name="note_packid" value="{{$package->id}}">
                    ...
                    <div id="doc_modal_{{$package->id}}" class="modal_photo white-popup-block mfp-hide">
                        ...
                        <div class="col-sm-12">
                            ...
                            <form method="post" action="{{route('customer.scan.request')}}">
                                ...
                                <input type="hidden" name="doc_packid" value="{{$package->id}}">
                            ...
                            @else
                                ...
                                @elseif($package->scanRequest->status == 'completed')
                    ...
                    <div id="return_send_{{$package->id}}" class="white-popup-block mfp-hide">
                        <div class="col-sm-12">
                            ...
                            <form method="post" action="{{route('customer.return.request')}}">
                                ...
                                <input type="hidden" name="return_packid" value="{{$package->id}}">
                    ...
                    <div id="split_pack_{{$package->id}}" class="white-popup-block mfp-hide">
                        <div class="col-sm-12">
                            ...
                            <form method="post" action="{{route('customer.split.request')}}">
                                ...
                                <a href="#" class="btn popup-modal-dismiss">Cancel Request</a>
                                <input type="hidden" name="split_packid" value="{{$package->id}}">
                                <button type="submit" class="btn btn-shoppre">Submit Request</button>
                            </form>
                        </div>
                        <div class="clearfix"></div>
                    ...
                    <div id="abandon_pack_{{$package->id}}" class="white-popup-block mfp-hide">
                        <div class="col-sm-12">
                            ...
                            <form method="post" action="{{route('customer.abandon.request')}}">
                                ...
                                <input type="hidden" name="abandon_packid" value="{{$package->id}}">
                                <button type="submit" class="btn btn-shoppre">YES</button>
                                <a href="#" class="btn popup-modal-dismiss">NO</a>
                            </form>
                        </div>
                    ...
                    <div id="photo_modal_{{$package->id}}" class="modal_photo white-popup-block mfp-hide">
                        ...
                        <div id="initiate_photo_{{$package->id}}">
                            <div class="blox photo_basic">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <a href="#" class="btn btn-shoppre photo_nxt" data-type="basic" data-pack="{{$package->id}}">Get Now</a>
                                </div>
                                <div class="clearfix"></div>
                                @endif
                            </div>
                            <div class="blox photo_advance">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <a href="#" class="btn btn-shoppre photo_nxt" data-type="advanced" data-pack="{{$package->id}}">Request Now</a>
                                </div>
                                <div class="clearfix"></div>
                                @endif
                            </div>
                        ...
                        <div id="basic_confirm_{{$package->id}}" class="noshow">
                            <div class="col-sm-3">
                                <img src="{{asset('img/basic_photo.png')}}">
                            </div>
                            <div class="col-sm-9">
                                <form class="basicphoto_form">
                                    ...
                                    <a href="#" class="btn btn-cancel" data-pack="{{$package->id}}">Cancel Request</a>
                                    <button type="submit" data-pack="{{$package->id}}" class="btn btn-shoppre basic_confirm_btn">Continue</button>
                                </form>
                            </div>
                            <div class="clearfix"></div>
                        </div>

                        <div id="basic_pending_{{$package->id}}" class="noshow">
                        ...
                        <div id="conirm_advcreq_{{$package->id}}" class="noshow">
                        ...
                        <div id="advanced_request_{{$package->id}}" class="advance_photo_container noshow">
                            <div class="col-sm-3">
                                <img src="{{asset('img/advance_photo.png')}}">
                            </div>
                            <div class="col-sm-9">
                                ...
                                <form class="advancedreq_form">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="advc_desc_{{$package->id}}" rows="8" placeholder="Type your message here"  name="description"></textarea>
                                    </div>
                                    <div class="checkbox">
                                      <label>
                                        <input id="advc_verify_{{$package->id}}" type="checkbox" name="verify" required>
                                    ...
                                    <div class="form-group" id="advc_error_{{$package->id}}">
                                    </div>
                                    <a href="#" class="btn btn-cancel" data-pack="{{$package->id}}">Cancel Request</a>
                                    <button type="submit" data-pack="{{$package->id}}" class="btn btn-shoppre advc_confirm_btn">Submit Request</button>
                                </form>
                            </div>
                            <div class="clearfix"></div>
                        </div>

                        <div id="std_photos_{{$package->id}}" class="std_photo_container noshow">
                            <h3>Photos from: <strong><span>{{$package->seller}}</span> | <span>{{$package->reference}}</span></strong></h3>
                            ...
                            @else
                                ...
                                <a href="#" class="photo_nxt" data-type="advanced" data-pack="{{$package->id}}">Request Additional photos for <i class="fa fa-rupee"></i> 500.00</a>
                            @endif
                        </div>
