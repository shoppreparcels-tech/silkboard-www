...
<body>
    <div class="invoice-box">
        <table cellpadding="0" cellspacing="0">
                ...
                <td colspan="4">
                    <table>
                        <tr>
                            ...
                            <td>
                                Invoice Number :# {{$shipment->id}}<br>
                                Order Number : # {{$shipment->order_id}}<br>
            ...
            <tr class="item">
              <td><strong>{{$package->seller}}</strong> - {{$package->reference}}</td>
              <td>{{$package->order_id}}</td>
              <td>INR {{number_format($package->price, 2, ".", "")}}</td>
              <td>{{$package->weight}} Kg.</td>
            </tr>
            @php
                $charges = array('storage' => 0, 'photo' => 0, 'pickup' => 0, 'handling' => 0, 'doc' => 0, 'address' => 0, 'split' => 0);
            ...
            <tr class="item">
              ...
              <td>INR {{number_format(($shipment->estimated-$shipment->package_level_charges-$shipment->pick_up_charge), 2, ".", "")}}</td>
            </tr>
            ...
            <tr class="item">
              ...
              <td>INR {{number_format($shipment->pick_up_charge, 2, ".", "")}}</td>
            </tr>
            @endif
            ...
            <tr class="item">
              <td colspan="2"></td>
              <td>Split Package :</td>
              <td>INR {{number_format($charges['split'], 2, ".", "")}}</td>
            </tr>
            @endif
            ...
            <tr class="item">
              ...
              <td>INR {{number_format(abs($shipment->wallet), 2, ".", "")}}</td>
            </tr>
            @endif
            ...
            <tr class="item">
              ...
              <td>INR {{number_format($shipment->payment_gateway_fee, 2, ".", "")}}</td>
            </tr>
            @endif
            <tr class="total">
              <td colspan="2"></td>
