                  ...
                  <div class="edit">
                      <div class="radio">
                          <label>
                              ...
                              @else
                                  <input type="radio" name="payment_gateway_name" value="wire"

                                          {{$shipment->axis_banned_item == 1?'checked':''}}>
                              @endif
                      ...
                      <div class="radio">
                          <label>
                              ...
                              @else
                                  <input type="radio" name="payment_gateway_name" value="cash"
                    ...
                    @if($wallet_amount >= $shipment->final_amount)
                      <div class="radio">
                        <label>
                              ...
                              @else
                                  <p style="display: inline-block">
                                      <input type="radio" name="payment_gateway_name" value="card"
                                              {{$shipment->is_axis_banned_item == 1?'disabled':''}}>
                                  <span class="label">Credit/Debit Card
                                          @if($shipment->is_axis_banned_item == 1)
                                              <a href="javascript:void(0)" class="tooltipkey" title="<p>This shipment have
                                      special items which are prohibited by debit/credit card payment gateways.So
                                      you can not choose this payment method.Use another option to make payment.</p>">
            ...
            <div class="col-sm-4">
                  ...
                  {{--<div class="shipsidebar">--}}
                      {{--<div class="form-group">--}}
                          {{--<form action="{{route('admin.promos.apply')}}" method="post">--}}
                              {{--{{csrf_field()}}--}}
                              {{--<div class="row">--}}
                                  {{--<div class="col-sm-8">--}}
                                      ...
                                      {{--@endif--}}
                                      {{--<input type="hidden" name="hdn_ship_id" value="{{$shipment->orderid}}">--}}
                                  {{--</div>--}}
                                  {{--<div class="col-sm-4">--}}
                  ...
                  <div class="dash-sidecost">
                    ...
                    <hr>
                    <h4>Subtotal: <span class="pull-right"><i class="fa fa-rupee"></i> <span class="sub_total">{{number_format($shipment->sub_total, 2, ".", "")}}</span></span></h4>
                    ...
                    <p>- If the amount is negative, it means that this amount will be added to the final charges.</p>
                      "><i class="fa fa-question-circle-o"></i></a> <span class="pull-right"><i class="fa fa-rupee"></i> <span class="discount">{{number_format(abs($shipment->wallet), 2, ".", "")}}</span></span>
                    ...
                    <h4>Basic Shipping Costs <span class="pull-right"><i class="fa fa-rupee"></i> <span class="estimated">{{number_format($estimated, 2, ".", "")}}</span></span></h4>
                  </div>
                  ...
                  <div class="dash-sidecost">
                      ...
                      <p>Scan Document <a href="javascript:void(0)" class="tooltipkey" title="<p>You can scan your documents (all/some pages of your document) for a charge of INR 40.00/day (Minimum INR 100)*</p><small>* Charges may be lesser for Membership Partners, and Loyalty Members (Silver and above).</small>
                        "><i class="fa fa-question-circle-o"></i></a> <span class="pull-right">{{number_format($charges['scan_doc'], 2, ".", "")}}</span></p>
                      @endif
                      ...
                      <hr>
                      <h4>Package Level Charges : <span class="pull-right"><i class="fa fa-rupee"></i> {{number_format($shipment->package_level_charges, 2, ".", "")}}</span></h4>
                  </div>
                  @endif
                  <div class="dash-sidecost">
                    ...
                    <h4>Package Level Charges <a href="javascript:void(0)" class="tooltipkey" title="<p>Shoppre includes all of the service charges (apart from shipping charges) under Package Level Charges. The break-up is as shown above.</p>
                      "><i class="fa fa-question-circle-o"></i></a> : <span class="pull-right"><i class="fa fa-rupee"></i> {{number_format($shipment->package_level_charges, 2, ".", "")}}</span></h4>

                    <h4>Coupon Discount <a href="javascript:void(0)" class="tooltipkey" title="<p>This Discount is applicable on Basic Shipping Costs only.</p>"><i class="fa fa-question-circle-o"></i></a> : <span class="pull-right">(-) <i class="fa fa-rupee"></i> {{number_format($payment['coupon'], 2, ".", "")}}</span></h4>
                    ...
                    <h4>Loyalty Rewards <a href="javascript:void(0)" class="tooltipkey" title="<p>For every 1,000 Shoppre Loyalty Points you earn, a credit of INR 100 will automatically be applied to your next shipment</p>
                      "><i class="fa fa-question-circle-o"></i></a> <span class="pull-right">(-) <i class="fa fa-rupee"></i> {{number_format($shipment->loyalty, 2, ".", "")}}</span></h4>

                    {{--@if((isset($shipment->option) && $shipment->option->insurance_amt > 0) && Request::get('insurance') =='')--}}
                    {{--<h4>Shipment insurance fee <a href="javascript:void(0)" class="tooltipkey" title="<p> Insure your shipment upto a total value of INR 6000 for only INR 30. Check our FAQ for more details.</p>"><i class="fa fa-question-circle-o"></i></a> <span class="pull-right"><i class="fa fa-rupee"></i>  {{number_format($shipment->option->insurance_amt, 2, ".", "")}}</span></h4>--}}
                      {{--@elseif((isset($shipment->option) && $shipment->option->insurance_amt > 0) && (Request::get('insurance') == 1))--}}
                      {{--<h4>Shipment insurance fee <a href="javascript:void(0)" class="tooltipkey" title="<p> Insure your shipment upto a total value of INR 6000 for only INR 30. Check our FAQ for more details.</p>"><i class="fa fa-question-circle-o"></i></a> <span class="pull-right"><i class="fa fa-rupee"></i>  {{number_format($shipment->option->insurance_amt, 2, ".", "")}}</span></h4>--}}
                    {{--@endif--}}
                    {{--@if(Request::get('insurance') == 1)--}}
                      {{--<h4>Shipment insurance fee <a href="javascript:void(0)" class="tooltipkey" title="<p> Insure your shipment upto a total value of INR 6000 for only INR 30. Check our FAQ for more details.</p>"><i class="fa fa-question-circle-o"></i></a> <span class="pull-right"><i class="fa fa-rupee"></i> 30 </span></h4>--}}
                      {{--@endif--}}

                    @if($payment['payment_gateway_fee'] > 0)
                    <h4>Payment Gateway (PG) Fee:  <span class="pull-right"><i class="fa fa-rupee"></i> {{number_format($payment['payment_gateway_fee'], 2, ".", "")}}</span></h4>
                    @endif
                    @if(Request::get('wallet') == 1 && $wallet_amount > 0)
                      <h4>Wallet Amount Used:  <span class="pull-right">(-)<i class="fa fa-rupee"></i> {{number_format($wallet_amount, 2, ".", "")}}</span></h4>
                    @endif
                  </div>
                    @if($wallet_amount < $shipment->final_amount && $wallet_amount !=0)
                      <div class="checkbox chkbox_background" >
                        <label class="label-width">
                          ...
                          <h4 class="amount-margin">Shoppre Wallet &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
                            <span class="pull-right"><i class="fa fa-rupee"></i> <span
                                class="estimated">{{$wallet_amount}}</span></span>
                          </h4>
                        </label>
                      </div>
                    @endif
                    {{--<div class="checkbox">--}}
                      {{--<label>--}}
                        {{--@if(Request::get('insurance') == null && (!isset($shipment->option) && ($shipment->option->insurance_amt <= 0) || ($shipment->option->insurance_amt == null) ) )--}}
                        {{--<input type="checkbox" name="insurance" value="2">--}}
                        {{--@elseif((Request::get('insurance') == 2 ) && (!isset($shipment->option) && ($shipment->option->insurance_amt <= 0) || ($shipment->option->insurance_amt == null) ) )--}}
                          {{--<input type="checkbox" name="insurance" value="2">--}}
                        {{--@else--}}
                          {{--<input type="checkbox" name="insurance" value="1" checked>--}}
                        {{--@endif--}}
                        {{--<span class="label">Protect your shipment with Shoppre insurance policy available for only--}}
                          {{--<i class="fa fa-rupee"></i>--}}
                          {{--30.00--}}
                          {{--<a href="javascript:void(0)" class="tooltipkey"--}}
                         {{--title="<p> Insure your shipment upto a total value of INR 6000 for--}}
                         {{--only INR 30. Check our FAQ for more details.</p>">--}}
                            {{--<i class="fa fa-question-circle-o"></i></a>--}}
                        {{--</span>--}}
                      {{--</label>--}}
                    {{--</div>--}}
                    <hr>
                  <div class="est_amount" style="background: #eaeaea;text-align: center;padding: 15px;border-radius: 5px;margin-bottom: 10px;">
                    <h4 style="font-weight: 600;font-size: 20px;margin-bottom: 0;">Final Shipping Charges *</h4>
                    <h3 style="font-weight: 800;margin-top: 10px;"><i class="fa fa-rupee"></i> {{number_format($payment['amount'], 2, ".", "")}}</h3>
                  </div>
                  <div class="form-group">
                    {{csrf_field()}}
                    <input type="hidden" name="ship_request_id" value="{{$shipment->id}}">
                    <button type="submit" id="submitship" class="btn btn-shoppre" style="width: 100%;font-size: 18px;border-radius: 5px;background: #10c018;font-weight: 900;">Proceed to Payment</button>
                  </div>
...
@section('js_script')
  ...
  <script type="text/javascript">
    ...
    $("#submitship").click(function(e) {
      ...
      {
        $.redirect("/shipping/request/payment/retry/submit",{
          _token: token,
