    ...
    <section class="shipprocess">
      <div class="container">
        <div class="row">
              ...
              <div class="longblock">
                ...
                <div id="changeAddress">
                  <div class="edit">
                    ...
                    <div class="radio">
                      <label>
                        @if($editadss->is_default)
                          <input type="radio" name="addressid" value="{{$editadss->id}}" checked>
                        @else
                          <input type="radio" name="addressid">
                        @endif
                        <span class="label"><strong>{{$editadss->name}}</strong>+{{$editadss->code}} {{$editadss->phone}}
                            <a href="{{route('customer.address.edit',[$editadss->id])}}?redirect={{url()->current()}}"  ><i class="fa fa-pencil-square-o"></i></a><br>
                        {{$editadss->line1}},
              ...
              <div class="longblock">
                ...
                <div id="changeSummery">
                  <div class="edit">
                      ...
                      <a href="{{route('shipping.request.cancel', [$shipment->order_id])}}" class="cancel">Cancel Request</a>
                  </div>
                </div>
              </div>
              <div class="longblock">
            ...
            <div class="col-sm-4">
              <div class="shipersonal_shopper_idebar">
...
@section('js_script')
  ...
  <script type="text/javascript">
    ...
    $("#submit_shiprqst").click(function(e) {
      ...
      var payment_gateway_name =  $("input[name='payment_gateway_name']").val();
