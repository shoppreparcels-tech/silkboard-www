                  ...
                  <div class="section">
                    ...
                    <div class="form-group">
                      ...
                      <ul class="ac_docs">
                        @if(!$docs->isEmpty())
                          @foreach($docs as $doc)
                            <li><a href="{{asset('uploads/documents')}}/{{$doc->customer_id}}/{{$doc->document_name}}" class="doc" target="_blank">{{$doc->document_name}}</a><a href="{{route('customer.account.docs.delete', ['id'=>$doc->id])}}" class="trash"><i class="fa fa-trash"></i></a></li>
                          @endforeach
                        @endif
                      </ul>
                    </div>
