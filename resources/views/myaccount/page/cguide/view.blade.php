        ...
        <div class="col-md-5">
          <div class="xchange_rate block">
            ...
            <form id="xchange_calc">
              <div class="form-group">
                <p id="xchange_display">1 INR = {{$xchange_rate}} {{$country->currency}}</p>
              </div>
              <div class="form-group">
                <div class="col-md-2">
  ...
  <section class="cguide_stores">
    <div class="container">
      <div class="col-md-8 col-md-offset-2 text-center">
        ...
        <p>Shoppre also offers a Personal Shopping Service where <a href="{{route('personal.shopper')}}">we can buy items on your behalf</a>. This comes in handy if an Indian website is not accepting your International credit card.</p>
      </div>
    </div>
  </section>
