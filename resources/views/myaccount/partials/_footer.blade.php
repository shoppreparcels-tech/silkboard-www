<footer>
    <section class="infolinks">
        <div class="container">
            <div class="row">
                <div class="col-sm-4">
                    <div class="logo">
                        <img src="https://www.shoppre.com/img/images/logo@2x.png" alt="shoppre logo">
                    </div>
                    <div class="contact_info">
                        <span><i class="glyphicon glyphicon-earphone"></i><strong><a href="tel:+91-8040944077">+91 80 4094 4077</a> </strong></span>
    ...
    <section class="bottom">
        <div class="container">
            <div class="row">
                <div class="col-sm-6">
                    <p class="copy">&copy; 2019, All Rights Reserved - by ShoppRe.com</p>
                </div>
                <div class="col-sm-6">
                    <div class="terms">
