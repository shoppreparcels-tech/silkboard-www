    ...
    <div class="content-area">
        <div class="breadcrumb-bar">
            <div class="page-title">
                <h1>Shipment Notifications</h1>
                <span>View All Shipment Notifications</span>
            </div>
        </div>
        <!-- Breadcrumb Bar -->
                                ...
                                <tbody>
                                    @foreach ($notifications as $notify)
                                        <tr>
                                            ...
                                            <td><a href="{{route('admin.shipping.order', [$notify->action_id])}}" class="green-text"><i class="ti-angle-double-right"></i></a></td>
                                        </tr>
                                    @endforeach
                                </tbody>
                              </table>
