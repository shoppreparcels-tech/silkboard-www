    ...
    <div class="content-area">
        <div class="breadcrumb-bar">
            <div class="page-title">
                <h1>Incoming Package Notifications</h1>
                <span>View All Incoming Alerts From Customers</span>
            </div>
        </div>
        <!-- Breadcrumb Bar -->
                                ...
                                <tbody>
                                    @foreach ($notifications as $notify)
                                        <tr>
                                            ...
                                            <td><a href="{{route('admin.incoming.orders')}}" class="green-text"><i class="ti-angle-double-right"></i></a></td>
                                        </tr>
                                    @endforeach
                                </tbody>
                              </table>
