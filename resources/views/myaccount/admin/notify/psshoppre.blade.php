    ...
    <div class="content-area">
        <div class="breadcrumb-bar">
            <div class="page-title">
                <h1>PS - SHOPRRE Notifications</h1>
                <span>View All Personal Shopper (Shoppre) Order Notifications</span>
            </div>
        </div>
        <!-- Breadcrumb Bar -->
                                ...
                                <tbody>
                                    @foreach ($notifications as $notify)
                                        <tr>
                                            ...
                                            <td><a href="{{route('admin.shopper.order', [$notify->action_id])}}" class="green-text"><i class="ti-angle-double-right"></i></a></td>
                                        </tr>
                                    @endforeach
                                </tbody>
                              </table>
