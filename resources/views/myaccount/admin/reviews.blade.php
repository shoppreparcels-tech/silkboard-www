                    ...
                    <div class="col s12">
                        ...
                        <form method="post" action="{{route('admin.reviews.submit')}}">
                            ...
                            <div class="input-field col s12">
                                <input type="text" class="validate" name="source" value="{{ old('source') }}" required>
                                    ...
                                    <td colspan="6">
                                        ...
                                        <form method="post" action="{{route('admin.reviews.update')}}">
                                            ...
                                            <div class="input-field col s6">
                                                <select name="country_id">
                                                    @foreach($countries as $country)
                                                    <option {{$review->country_id === $country->id ? "selected" : ""}} value="{{$country->id}}">{{$country->name}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            <div class="input-field col s12">
                                                <input type="text" class="validate" name="source" value="{{$review->source}}" required>
                                                <label class="active">Source</label>
                                            </div>
                                            <div class="input-field col s12">
...
<script type="text/javascript">
    $(".slide_trigger").click(function(t){t.preventDefault();var e=$(this).attr("data-target");$("#slidedown_"+e).slideToggle()});
</script>
@endsection
