                ...
                <div class="masonary">
                    <div class="col s12">
                        ...
                        <form method="post" action="{{route('admin.pages.submit')}}">
                            ...
                            <div class="input-field col s12">
                                <textarea name="meta_title" class="materialize-textarea">{{ old('meta_title') }}</textarea>
                            ...
                            <div class="input-field col s12">
                                <textarea name="meta_description" class="materialize-textarea">{{ old('meta_description') }}</textarea>
                            ...
                            <div class="input-field col s12">
                                <textarea name="meta_keyword" class="materialize-textarea">{{ old('meta_keyword') }}</textarea>
