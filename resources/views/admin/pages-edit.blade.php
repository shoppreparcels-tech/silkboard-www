                ...
                <div class="masonary">
                    <div class="col s12">
                        ...
                        <form method="post" action="{{route('admin.pages.update')}}">
                            ...
                            <div class="input-field col s12">
                                <textarea name="metatitle" class="materialize-textarea">{{$page->metatitle}}</textarea>
                            ...
                            <div class="input-field col s12">
                                <textarea name="metadesc" class="materialize-textarea">{{$page->metadesc}}</textarea>
                            ...
                            <div class="input-field col s12">
                                <textarea name="metakeyword" class="materialize-textarea">{{$page->metakeyword}}</textarea>
