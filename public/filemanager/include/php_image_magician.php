...
*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-**-*-*-*-*-*-*-*-*-*-*-*-*-*/
	...
	public function rotate($value = 90, $bgColor = 'transparent')
		...
		#               (str) param "upersonal_shopper_ide": upersonal_shopper_ide-down image
		# Param out:
		# Reference:
...
*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-**-*-*-*-*-*-*-*-*-*-*-*-*-*/
		...
		#
	{
		...
		if (isset($exifData['COMPUTED']['Apertureference_numberber']))
		{
			$exifDataArray['f-stop'] = $exifData['COMPUTED']['Apertureference_numberber'];
		}
		else
		{
