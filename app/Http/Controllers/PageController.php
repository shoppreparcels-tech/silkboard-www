...
//           var_dump($result);
    ...
    public function booksFromIndia()
    {
    ...
    public function fabindiaProduct()
    {
    ...
    public function chumbakProduct()
    {
        return view('page.landing-pages.chumbak-product');
    }
    public function maxidressMyntra()
    {
        return view('page.landing-pages.maxidress-myntra');
    }
    public function kurtisMyntra()
    {
    ...
    public function chicagoShipping()
    {
        return view('page.landing-pages.usa-chicago');
    }
    public function losangelesShipping()
    {
        return view('page.landing-pages.usa-losangeles');
    }
    public function michiganShipping()
    {
        return view('page.landing-pages.usa-michigan');
    }
    public function newjerseyShipping()
    {
        return view('page.landing-pages.usa-newjersey');
    }
    public function newyorkShipping()
    {
        return view('page.landing-pages.usa-newyork');
    }
    public function texasShipping()
    {
        return view('page.landing-pages.usa-texas');
    }
    public function floridaShipping()
    {
        return view('page.landing-pages.usa-florida');
    }
    public function californiaShipping()
    {
    ...
    public function detroitShipping()
    {
        return view('page.landing-pages.usa-detroit');
    }
    public function austinShipping()
    {
        return view('page.landing-pages.usa-austin');
    }
    public function connecticutShipping()
    {
        return view('page.landing-pages.usa-connecticut');
    }
    public function northamericaShipping()
    {
        return view('page.landing-pages.usa-northamerica');
    }
    public function edisonShipping()
    {
    ...
    public function eastwestShipping()
    {
    ...
    public function shipChinamask()
    {
        return view('page.landing-pages.shipChinamask');
    }
    public function countryJapan()
    {
        return view('page.landing-pages.country-japan');
    }
    public function countryUsa()
    {
        return view('page.landing-pages.country-usa');
    }
...
//            print json_encode($feats);exit;
    ...
    public function pricingMalaysia()
    {
        return view('page.landing-pages.pricing-malaysia');
    }
    ...
    public function pricingMexico()
    {
        return view('page.landing-pages.pricing-mexico');
    }
    public function pricingSrilanka()
    {
        return view('page.landing-pages.pricing-srilanka');
    }
    public function pricingHongkong()
    {
        return view('page.landing-pages.pricing-hongkong');
    }
    public function pricingSpain()
    {
        return view('page.landing-pages.pricing-spain');
    }
    public function pricingBrazil()
    {
        return view('page.landing-pages.pricing-brazil');
    }
    public function pricingPhilippines()
    {
        return view('page.landing-pages.pricing-philippines');
    }
    public function pricingBelgium()
    {
        return view('page.landing-pages.pricing-belgium');
    }
